package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_592:IAssetLibrary;
      ...
      public function define(param1:XML) : Boolean
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(_loc4_.length() > 0)
            {
               ...
               _loc11_ = var_592.getAssetByName(_loc6_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean) : Boolean
      {
         ...
         var _loc4_:BitmapDataAsset = var_592.getAssetByName(param1) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            _loc4_ = new BitmapDataAsset(var_592.getAssetTypeDeclarationByClass(BitmapDataAsset));
            var_592.setAsset(param1,_loc4_);
