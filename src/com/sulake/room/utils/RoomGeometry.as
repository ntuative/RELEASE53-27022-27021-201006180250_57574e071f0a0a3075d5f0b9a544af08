package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_715:Number = 64;
      ...
      private var var_1527:Number = 1.0;
      ...
      private var var_1528:Number = 1.0;
      
      private var var_2490:Number = 500.0;
      ...
      private var var_2491:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_87 = new Vector3d();
         var_1047 = new Vector3d();
         var_1527 = 1;
         var_1526 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1528 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_229.assign(param1);
         if(var_229.x != _loc2_ || var_229.y != _loc3_ || var_229.z != _loc4_)
         {
            ++var_76;
         }
      ...
      {
         if(var_408 != param1 * var_1528)
         {
            var_408 = param1 * var_1528;
            ++var_76;
         }
      }
      ...
      {
         if(var_410 != param1 * var_1527)
         {
            var_410 = param1 * var_1527;
            ++var_76;
         }
      }
      ...
      {
         if(var_407 != param1 * var_1526)
         {
            var_407 = param1 * var_1526;
            ++var_76;
         }
      }
      ...
      {
         return new Vector3d(var_229.x,var_229.y,var_229.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1047.assign(_loc22_);
         }
         else
         {
            var_1047.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_407;
         _loc2_.z *= var_408;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1047);
         if(_loc3_ < var_2491 || _loc3_ > var_2490)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_407;
            _loc2_.z *= var_408;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1047);
         }
      ...
      {
         return new Vector3d(0 * var_410,0 * var_407,0 * var_408);
      }
      ...
      {
         return scale == const_715;
      }
      
      public function get scale() : Number
      {
         return var_150 / Math.sqrt(0.5);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_150;
         var _loc6_:Number = -param1.y / var_150;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_86,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_410,0 * var_407,0 * var_408);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_87;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_410,param2.y * var_407,param2.z * var_408);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_410,param3.y * var_407,param3.z * var_408);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_410,param4.y * var_407,param4.z * var_408);
