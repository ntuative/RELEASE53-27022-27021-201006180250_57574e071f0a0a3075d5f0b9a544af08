package com.sulake.room.renderer
{
   ...
   public class RoomRenderer implements IRoomRenderer, IRoomSpriteCanvasContainer
   {
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_138.getWithIndex(_loc2_) as RoomSpriteCanvas;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      {
         return var_138.getValue(String(param1)) as IRoomRenderingCanvas;
      }
      
      public function disposeCanvas(param1:int) : Boolean
      {
         var _loc2_:RoomSpriteCanvas = var_138.remove(String(param1)) as RoomSpriteCanvas;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
         }
      ...
      public function render() : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_138.getWithIndex(_loc2_) as IRoomRenderingCanvas;
            if(_loc3_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(var_138 != null)
         {
            ...
            {
               _loc2_ = var_138.getWithIndex(_loc1_) as RoomSpriteCanvas;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function removeRoomObject(param1:int) : void
      {
         ...
         {
            _loc4_ = var_138.getWithIndex(_loc3_) as RoomSpriteCanvas;
            if(_loc4_ != null)
            {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:IRoomRenderingCanvas = var_138.getValue(String(param1)) as IRoomRenderingCanvas;
         if(_loc5_ != null)
         {
         ...
         var_138.add(String(param1),_loc5_);
         return _loc5_;
      }
