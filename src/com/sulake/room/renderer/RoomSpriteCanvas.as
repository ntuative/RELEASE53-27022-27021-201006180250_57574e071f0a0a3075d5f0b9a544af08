package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1463:int = 50;
      ...
      private var var_239:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1590:Boolean = false;
      
      private var var_2035:Number = -1.0E7;
      
      private var var_2033:Number = -1.0E7;
      
      private var var_2493:int = 0;
      
      private var var_516:RoomObjectCache;
      
      private var var_747:int;
      
      private var var_274:Sprite;
      
      private var var_1086:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_239 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_318 = new Map();
         var_516 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_239.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_239.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_516.removeObjectCache(param1);
      }
      ...
      public function update() : void
      {
         if(var_899 == 0)
         {
            checkMouseHits(var_1087.x,var_1087.y,MouseEvent.MOUSE_MOVE);
         }
         var_899 = 0;
         ++var_780;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_54.graphics.beginFill(var_2493);
      ...
      {
         var _loc11_:Number = param1 - var_747 / 2;
         var _loc12_:Number = param2 - var_746 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_747 != var_2034 || var_746 != var_2031)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_443.sortOn("z",0 | 0);
         if(_loc5_ < var_443.length)
         {
            var_443.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_443[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(var_515 != null)
         {
            ...
            {
               cleanSprite(var_515[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_515 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_318 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_318.getKey(_loc1_);
            _loc3_ = var_318.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1086 != null)
                  {
                     var_1086.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_780,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_239.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_239.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1087.x = param1;
         var_1087.y = param2;
         if(var_899 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1590;
         }
         var_1590 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_899;
         return var_1590;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_443.length)
         {
            return null;
         }
         return var_443[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_517.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_517.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2035 || param2 != var_2033)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_517.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_517.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_515.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_239.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_239.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_516.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_516.getObjectCache(param2);
         ...
         _loc13_ += int(var_747 / 2);
         _loc14_ += int(var_746 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_747 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_746))
                  {
