package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         var _loc3_:BitmapDataCacheItem = var_379.getValue(param1) as BitmapDataCacheItem;
         if(_loc3_ != null)
         {
      ...
      public function compress() : void
      {
         ...
         {
            var_378.sortOn("useCount",0 | 0);
            _loc2_ = -1;
            while(_loc2_ >= 0)
            {
               _loc1_ = var_378[_loc2_] as BitmapDataCacheItem;
            ...
            var_378.splice(_loc2_,0 - _loc2_);
            if(memUsage > memLimit)
            {
               var_378.sortOn("memUsage",Array.NUMERIC);
               while(memUsage > memLimit)
               {
                  _loc1_ = var_378.pop() as BitmapDataCacheItem;
                  if(_loc1_ == null)
                  {
                     break;
                  }
      ...
      {
         var _loc2_:BitmapDataCacheItem = var_379.getValue(param1) as BitmapDataCacheItem;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function removeItem(param1:BitmapDataCacheItem) : void
      {
         ...
         param1 = var_379.remove(param1.name) as BitmapDataCacheItem;
         if(param1 != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_379 != null)
         {
            ...
            {
               _loc2_ = var_379.getWithIndex(_loc1_) as BitmapDataCacheItem;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
