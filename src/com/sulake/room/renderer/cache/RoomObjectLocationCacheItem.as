package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      {
         if(param1 != var_1440 || param2 != var_2094)
         {
            var_1440 = param1;
            var_2094 = param2;
            return true;
         ...
         if(param3)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     var_277 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
                     var_277.assign(_loc5_);
                  }
               }
               else
               {
            ...
            var_277.x = Math.round(var_277.x);
            var_277.y = Math.round(var_277.y);
         }
         return var_277;
      }
