package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_130:IRoomRendererBase;
      ...
      {
         if(var_1040.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            var_1040.push(param1);
         }
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(var_130)
               {
                  var_130.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_130)
                  {
                     var_130.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
