package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_390:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1225 != null)
         {
            _loc2_ = var_1225.tags[0];
            var_1225.color = getBgColor(_loc2_);
         }
         var_1225 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_390 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1785 - _loc2_.stageX);
         var_1785 = _loc2_.stageX;
         var_1786 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_120,null,0);
         method_5(param1,param2);
         var_840.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               {
                  case RoomSettingsFlatInfo.const_120:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1276,true);
