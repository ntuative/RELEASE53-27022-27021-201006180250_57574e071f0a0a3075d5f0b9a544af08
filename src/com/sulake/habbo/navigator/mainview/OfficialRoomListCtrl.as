package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1163:int = 267;
      
      private static const const_1162:int = 65;
      
      private static const const_1161:int = -70;
       
      
      private var var_2274:PublicRoomThumbs;
      
      private var var_20:IWindowContainer;
      
      private var _navigator:HabboNavigator;
      
      private var var_840:UserCountRenderer;
      
      private var var_49:IItemListWindow;
      
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         var_2274 = new PublicRoomThumbs();
         super();
         _navigator = param1;
         var_840 = new UserCountRenderer(_navigator);
      }
      ...
      {
         var _loc4_:String = var_2274.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1161) : 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1366)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1162) : int(const_1163);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_749 || param2.type == OfficialRoomEntryData.const_694))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_840.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_334,_loc2_.tag);
         }
