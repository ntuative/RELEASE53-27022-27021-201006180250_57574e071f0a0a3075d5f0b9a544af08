package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_486:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_486 == null ? 0 : int(var_486.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_333);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_529);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_333,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_486 == null)
         {
            var_486 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_486.procedure = onChangeFilter;
