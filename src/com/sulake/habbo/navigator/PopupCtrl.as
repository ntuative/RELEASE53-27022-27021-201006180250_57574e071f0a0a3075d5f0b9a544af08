package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_369.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_369)
         {
            var_369.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_369.reset();
            var_369 = null;
         }
         if(var_326)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_50 == null)
         {
            var_50 = IWindowContainer(_navigator.getXmlWindow(var_1276));
            var_50.visible = false;
         ...
         var_50.x = _loc2_.x + var_2140 + param1.width;
