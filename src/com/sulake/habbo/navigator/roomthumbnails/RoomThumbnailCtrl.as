package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1904:IWindowContainer;
      ...
      private var var_1903:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1550,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1549,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1550 = IButtonWindow(find("top_tab"));
         var_1549 = IButtonWindow(find("obj_tab"));
         var_1903 = IWindowContainer(find("tile_grid"));
         var_1904 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1550,onTopTabButton);
         Util.setProcDirectly(var_1549,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1903;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_397)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1904;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,param1.width,66)));
