package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1121:int = -16;
      
      private static const const_790:int = 32;
      
      private static const const_1119:int = 8;
      ...
      private var var_2084:Dictionary;
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_43 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1121,_loc4_.y + const_1120 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2084[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_41,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_907.getImage(ThumbnailEditorModel.const_41,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_790 / 2);
         return new Point(param1 * const_790 + _loc3_,param2 * const_1119);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_397)
         {
            var_1092[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1092[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_397)
         {
            if(false)
            {
               refreshObj(param1,var_1092[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1337 == null)
         {
            var_1337 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1337,var_1337.rect,new Point(0,0),null,null,true);
      }
   }
}
