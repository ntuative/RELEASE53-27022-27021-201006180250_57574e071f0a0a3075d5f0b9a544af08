package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1750:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1749 = this._navigator.getButtonImage(this.var_1747);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1750 == null)
         {
            ...
            this.var_1750 = new Rectangle(var_1492,var_1492,_loc1_.width - 2 * var_1492,_loc1_.height - 2 * var_1492);
         }
         var_699.bitmap.fillRect(var_699.bitmap.rect,4281545523);
         var_699.bitmap.fillRect(this.var_1750,4284900966);
         copyTo(var_699.bitmap);
         if(_selected)
         {
            var_699.bitmap.copyPixels(var_1748,var_1748.rect,new Point(0,0),null,null,true);
         }
         var_699.invalidate();
      }
