package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_1921:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1921 = new RoomThumbnailRenderer(param1);
         var_929 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_187,var_121.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_187.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_187.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_929.refreshTags(_loc1_,var_121.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1921.refreshThumbnail(_loc1_,var_121.thumbnail,false);
         _loc1_.findChildByName("bitmap").visible = true;
         _loc1_.visible = true;
      }
      
      private function method_5(param1:IWindowContainer, param2:GuestRoomData) : void
      {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_187 == null)
         {
            var_187 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_187.visible = true;
         Util.hideChildren(var_187);
         method_5(var_187,var_121);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_187,!true ? getEventCtg(var_121.categoryId) : getRoomCtg(var_121.categoryId));
         refreshRoomDesc(var_187,var_121);
         refreshExtraCont();
         refreshInfo(var_187,"trading_allowed",var_121.allowTrading);
         refreshInfo(var_187,"doormode_doorbell",false);
         refreshInfo(var_187,"doormode_password",false);
         Util.moveChildrenToColumn(var_187,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_187.height = Util.getLowestPoint(var_187);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_243,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
