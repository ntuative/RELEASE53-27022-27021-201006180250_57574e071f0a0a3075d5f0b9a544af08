package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_173,HabboToolbarIconEnum.EXITROOM);
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         else if(_loc2_.roomForward)
         {
            ...
            else if(_loc2_.data.doorMode == RoomSettingsData.const_120 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         if(_navigator.configuration.getKey("roomenterad.habblet.enabled") == "HabboRoomWidgetLib_memenu_settings_slider_button" && false)
         {
