package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1678:CutToHeight = new CutToHeight();
      
      private static var var_1677:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1678.beforeSearch(param2,param1,param3);
         binarySearch(var_1678,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1677.beforeSearch(param2,param1,param3);
         binarySearch(var_1677,param2.length - 1);
      }
   }
}
