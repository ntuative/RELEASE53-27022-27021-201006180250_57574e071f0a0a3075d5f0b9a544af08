package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_723:ICheckBoxWindow;
      ...
      private var var_1893:ITextWindow;
      
      private var var_1065:IWindowContainer;
      ...
      private var var_926:TextFieldManager;
      ...
      private var var_1892:ITextWindow;
      ...
      private var var_1063:TextFieldManager;
      ...
      private function clearErrors() : void
      {
         ...
         this.var_926.clearErrors();
         this.var_1063.clearErrors();
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         if(param1 != this.var_425 || var_1066 < 1)
         {
            return;
         }
         var_1066 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1182)
         {
            this.var_861.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1339)
         {
            this.var_861.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1388)
         {
            this.var_1264.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1211)
         {
            setTagError(this.var_927,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_926,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1190)
         {
            setTagError(this.var_927,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_926,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1374)
         {
            this.var_1063.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_861.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function populateForm() : void
      {
         ...
         var_861.setText(_loc1_.name);
         var_1264.setText(_loc1_.description);
         var_1063.setText("");
         var_1263.setText("");
         ...
         setTag(var_927,_loc1_.tags[0]);
         setTag(var_926,_loc1_.tags[1]);
         if(var_1266)
         {
            if(_loc1_.allowPets)
            {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_58,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,100,20)));
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_861.getText();
         _loc2_.description = var_1264.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_434;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_120)
         {
            _loc8_ = var_1063.getText();
            _loc9_ = var_1263.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1063.clearErrors();
               this.var_1263.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.hideWalls = var_723.isSelected;
         _loc2_.tags = new Array();
         addTag(var_927,_loc2_.tags);
         addTag(var_926,_loc2_.tags);
         this.clearErrors();
         this.var_1066 = _loc2_.roomId;
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1548.visible = _inRoom;
         var_1547.visible = _inRoom;
         var_1893.visible = var_502;
         var_1892.visible = !var_502;
         if(var_502)
         {
            var_1067.visible = true;
            var_1267.visible = false;
            refreshFlatControllers();
            var_1067.height = Util.getLowestPoint(this.var_1067) + 4;
         }
         else
         {
            populateForm();
            ...
            var_1265.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1265.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1065.height = Util.getLowestPoint(this.var_1065) + 4;
         }
         var_1546.text = !!var_502 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1548.name,var_1265.name,var_1065.name,var_1067.name,var_1267.name,var_1547.name],0,0);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_579,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_1021,onDoorModePasswordUnselect);
         ...
         _window.findChildByName("edit_user_defined_room_events").visible = _navigator.configuration.getKey("userdefinedroomevents.enabled","false") == "HabboRoomWidgetLib_memenu_settings_slider_button";
         this.var_861 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1264 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_927 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_926 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1063 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1263 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         ...
         this.var_723 = ICheckBoxWindow(_window.findChildByName("hide_walls_checkbox"));
         var_1548 = IWindowContainer(_window.findChildByName("header_container"));
         var_1265 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1065 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1067 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1547 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1267 = IWindowContainer(_window.findChildByName("footer_container"));
         var_265 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1064 = IWindowContainer(_window.findChildByName("password_container"));
         var_1892 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1893 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1546 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1546.procedure = onSwitchView;
