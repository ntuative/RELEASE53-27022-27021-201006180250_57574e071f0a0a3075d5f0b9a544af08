package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_886:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_509 = new Timer(100);
         var_509.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_39 = new Array();
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,104,"a"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,94,"b"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,36,"c"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,84,"d"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"e"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"f"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,416,"i"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,320,"j"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,448,"k"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,352,"l"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,384,"m"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_51,372,"n"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,80,"g"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,74,"h"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,416,"o"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,352,"p"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,304,"q"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,336,"r"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,748,"u"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_62,438,"v"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,540,"t"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,512,"w"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,396,"x"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,440,"y"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,456,"z"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_55,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1073 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_509)
         {
            var_509.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_509.reset();
            var_509 = null;
         }
      }
      ...
      {
         var_1073.goBackToInitialState();
         var_1073.input.textBackgroundColor = 4294967295;
         var_886 = var_39[0];
         this.method_4();
         refreshSelection();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_58,HabboWindowStyle.const_42,HabboWindowParam.const_73,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1073.getText();
      ...
      {
         var _loc1_:Boolean = var_1073.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_886.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1305 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1305 = true;
            _loc3_.y = 1;
