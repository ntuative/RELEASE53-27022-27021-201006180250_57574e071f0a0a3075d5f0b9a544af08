package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2513:Dictionary;
      ...
      private var var_869:RoomCreateViewCtrl;
      ...
      private var var_503:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_465:Tabs;
      
      private var var_268:MainViewCtrl;
      
      private var var_1920:Array;
      
      private var var_1063:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_503 = new RoomInfoViewCtrl(this);
         var_869 = new RoomCreateViewCtrl(this);
         var_1921 = new RoomThumbnailRenderer(this);
         var_1063 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_465 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_268.startSearch(Tabs.const_216,Tabs.const_334,param1);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_143.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_503.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_268.startSearch(Tabs.const_273,Tabs.const_232);
         var_465.getTab(Tabs.const_273).tabPageDecorator.tabSelected();
      }
