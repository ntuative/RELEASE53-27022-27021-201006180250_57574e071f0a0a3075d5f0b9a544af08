package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_860:IAvatarImage;
      ...
      private function updateBodyPartCache(param1:String, param2:AvatarImageBodyPartCache) : void
      {
         ...
         var_134.add(param1,param2);
      }
      
      public function setGeometryType(param1:String) : void
      {
         if(var_621 == param1 || var_621 == GeometryType.const_983 && param1 == GeometryType.const_883 || param1 == GeometryType.const_983 && var_621 == GeometryType.const_883)
         {
            var_621 = param1;
            return;
         }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_134.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_134.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_79.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_568)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_435)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_79.getParts(param1,var_860.getFigure(),_loc6_,var_621,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_79.getCanvas(var_150,var_621);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1240[param1])
            {
            ...
            _loc9_ = var_150 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_150 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               {
                  _loc33_ = var_79.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc30_ == AvatarAction.const_857 || _loc30_ == AvatarAction.const_444) && (_loc6_ == AvatarBodyPartType.const_241 || _loc6_ == AvatarBodyPartType.const_1307 || _loc6_ == AvatarBodyPartType.const_1279) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_150 == AvatarScaleType.const_54)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_134 != null)
         {
            _loc2_ = var_134.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_134.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_134 != null)
         {
            ...
            {
               _loc5_ = var_134.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
