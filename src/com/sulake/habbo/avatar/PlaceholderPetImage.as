package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      public function PlaceholderPetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:IAssetLibrary)
      {
         ...
         _assets = param5;
         var_505 = new Map();
         var _loc6_:AvatarCanvas = var_79.getCanvas(var_150,var_259.definition.geometryType);
         if(_loc6_)
         {
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc3_:BitmapData = getPlaceHolderImage(var_93,var_150);
         if(!_loc3_ || !_image)
         {
            return null;
         }
      ...
      override public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc2_:BitmapData = getPlaceHolderImage(var_93,var_150);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = var_505.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            var_505.add(_loc3_,_loc4_.clone());
            _loc4_ = var_505.getValue(_loc3_);
         }
         return _loc4_;
      }
