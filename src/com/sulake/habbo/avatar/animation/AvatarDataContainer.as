package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1806:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1599,var_1598,var_1600,_alphaMultiplier);
         var_1041 = generatePaletteMapForGrayscale(var_1805,var_1807);
      }
