package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1789 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_1035 = new Dictionary();
         var_1508 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_1035[String(_loc3_.@id)] = _loc5_;
         }
         for each(_loc4_ in param1.bodypart)
         {
            var_1508.push(String(_loc4_.@id));
         }
      }
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1508.concat();
         for each(_loc2_ in var_1035)
         {
