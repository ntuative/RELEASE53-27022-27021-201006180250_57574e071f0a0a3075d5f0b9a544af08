package com.sulake.habbo.avatar.geometry
{
   ...
   public class GeometryBodyPart extends Node3D
   {
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1345);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1345);
         return Math.min(_loc2_,_loc3_);
      }
      
      public function hasPart(param1:String) : Boolean
      {
         var _loc2_:GeometryItem = var_173[param1];
         return _loc2_ != null;
      }
