package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_482:Matrix4x4;
      
      private var var_834:Vector3D;
      
      private var var_138:Dictionary;
      
      private var var_702:Dictionary;
      
      private var var_1499:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_834 = new Vector3D(0,0,10,0);
         super();
         var_482 = new Matrix4x4();
         var_702 = new Dictionary();
         var_1499 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            var_702[String(_loc6_.@id)] = _loc7_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_482 = var_482.identity().rotateY(param3);
            return _loc5_.getParts(var_482,var_834,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1499.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_702[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_138[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_482 = var_482.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_482);
            _loc10_ = _loc8_.getDistance(var_834);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_702[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1499.findAvatarSet(param1);
         if(_loc3_ != null)
         {
