package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_87 * param1.y;
         _loc2_.y = var_87 * param1.x - var_86 * param1.z;
      ...
      {
         return Math.sqrt(var_86 * var_86 + _y * _y + var_87 * var_87);
      }
      ...
      {
         return var_86 * param1.x + _y * param1.y + var_87 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_86 + "," + _y + "," + var_87 + "," + var_1182 + ")";
      }
