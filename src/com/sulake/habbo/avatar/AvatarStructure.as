package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_463:PartSetsData;
      
      private var var_1672:PartOffsetData;
      
      private var var_978:AvatarActionManager;
      
      private var var_185:IAssetLibrary;
      
      private var var_979:IAssetLibrary;
      
      private var var_414:AvatarRenderManager;
      
      private var var_332:FigureData;
      
      private var var_630:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_671:String;
      
      private var var_1671:AvatarStructureDownloadSet;
      
      private var var_1424:Array;
      
      private var var_809:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_185 = param2;
         var_979 = param3;
         var_332 = new FigureData();
         var_463 = new PartSetsData();
         var_630 = new AnimationData();
         var_1671 = new AvatarStructureDownloadSet();
         var_809 = new AnimationManager();
         var_671 = param4;
         var_1672 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_978.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_671)
         {
            case AvatarType.const_78:
               _loc1_ = var_185.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_463.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_185.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_630.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_185.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_332.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_185.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_463.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_185.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_630.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_185.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_332.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_978.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_332.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_978.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_809.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_463.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_463.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1223[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_978.getDefaultAction();
         var _loc9_:Array = var_463.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_809.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_332.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_332.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_630.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_463.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_463.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_671 + " ready to go!");
         if(var_671 == AvatarType.const_78)
         {
            var_463.getPartDefinition("ri").appendToFigure = true;
            var_463.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_78:
               if(var_185.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_185.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_185.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_185.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_78:
               if(var_185.hasAsset(_loc5_))
               {
                  var_185.removeAsset(var_185.getAssetByName(_loc5_));
               }
               var_1671.add(new AvatarStructureDownload(var_185,_loc5_,var_332));
               break;
            case AvatarType.PET:
         }
         var_1671.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_809.getAnimation(param1);
      }
      ...
      {
         var_978 = new AvatarActionManager(var_185,var_671);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1424 = var_332.getMandatorySetTypeIds();
         return var_1424;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_332.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_979.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_979.getAssetByName("dance" + _loc1_).content as XML;
            var_809.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_979.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_979.getAssetByName("fx" + _loc1_).content as XML;
            var_809.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_332.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_332.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1672.loadOffsets(var_979);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_978.sortActions(param1);
      }
   }
}
