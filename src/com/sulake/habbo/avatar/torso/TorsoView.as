   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_188,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_164,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_168,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_149 == "")
         {
            _model.switchCategory(FigureData.const_164);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  switchCategory(FigureData.const_188);
                  break;
               case "tab_shirt":
                  switchCategory(FigureData.const_164);
                  break;
