package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_736:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_735.width,var_735.height,true,0);
            _loc1_.bitmap.copyPixels(var_735,var_735.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_882.width,var_882.height,true,0);
            _loc5_ = var_882.clone();
            _loc5_.colorTransform(_loc5_.rect,var_736.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_734.width,var_734.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_734,var_734.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
