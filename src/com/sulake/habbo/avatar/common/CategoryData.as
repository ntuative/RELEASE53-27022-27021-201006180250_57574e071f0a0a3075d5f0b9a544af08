package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1743:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_720 >= 0 && var_173.length > var_720)
         {
            _loc2_ = var_173[var_720];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_173.length > param1)
         {
            _loc3_ = var_173[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_198.length)
         {
            ...
            {
               if(_loc7_.length > var_198[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_198[param2],param2);
         var_198[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_198[param1])
         {
            return null;
         }
      ...
      {
         return var_173[var_720] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_198 = new Array(param1.length);
         var _loc3_:int = 0;
