package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_602:IFigurePartSet;
      
      private var var_1534:int = 0;
      
      private var var_414:IAvatarRenderManager;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1534 = Math.max(var_1534,_loc6_.colorLayerIndex);
            }
         }
         var_414 = _model.controller.avatarRenderManager;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(var_415 == null)
         {
            if(!analyzePartLayers())
            {
               if(!var_1533)
               {
                  ...
                  var_1533 = _loc9_.content as BitmapData;
               }
               return var_1533;
            }
         }
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_249[_loc6_] + "_" + FigureData.const_114;
               _loc4_ = var_414.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
            ...
            if(_loc4_)
            {
               ...
               if(var_1535 && _loc2_.colorLayerIndex > 0)
               {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = var_414.createFigureContainer("undefined-undefined");
         Logger.log("QUERYING SET:undefined-undefined");
         if(!var_414.isFigureReady(_loc1_))
         {
            var_414.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
