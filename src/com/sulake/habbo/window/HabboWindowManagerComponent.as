package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_366:uint = 3;
      ...
      private var var_740:ISkinContainer;
      ...
      private var var_1306:ProfilerAgentTask;
      
      private var var_1307:IEventDispatcher;
      
      private var var_2515:uint = 0;
      
      private var var_1308:ProfilerAgentTask;
      
      private var var_1309:ProfilerOutput;
      
      private var var_739:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1307 = Component(param1).events;
         var_436 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_740 = new SkinContainer(_loc3_.content as XML,assets);
         var_739 = new WindowRenderer(var_740);
         var_236 = new Array(const_366);
         var _loc5_:int = 0;
         while(_loc5_ < const_366)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_739,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_236[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_247 = var_236[const_1107];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_247.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_247.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1221,_loc6_);
      }
      ...
      {
         return var_236[param1].getDesktopWindow().getChildAt(var_247.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_436[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_436[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1309 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1309 = new ProfilerOutput(_loc3_,this,var_739);
               var_1306 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1306);
               var_1308 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1308);
               var_1076 = true;
            }
         }
      }
      ...
      {
         return var_247.getWindowParser().windowToXMLString(param1);
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return var_740.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_1006.length > 0)
         {
            var_1307.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_366 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1307.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_366)
         {
         ...
         if(WindowContext.var_1006.length > 0)
         {
            WindowContext.var_1006.flush();
         }
         if(WindowContext.var_1470.length > 0)
         {
            WindowContext.var_1470.flush();
         }
         var_1307.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_247.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1400,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1382,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1246,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1300,param2.name + ": " + param2.toString());
            }
         }
      }
   }
