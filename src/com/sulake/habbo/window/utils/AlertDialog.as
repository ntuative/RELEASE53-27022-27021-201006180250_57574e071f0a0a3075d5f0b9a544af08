package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1097:String = "_alert_button_list";
      
      private static const const_779:String = "_alert_button_cancel";
      
      private static const const_692:String = "_alert_button_ok";
      
      private static const const_1365:String = "_alert_text_summary";
      
      private static var var_689:uint = 0;
      
      private static const const_778:String = "_alert_button_custom";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = _window.findChildByName(const_1097) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_692);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(_window)
         {
            ITextWindow(_window.findChildByTag("DESCRIPTION")).text = var_1457;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_193 != null)
                  {
                     var_193(this,new WindowEvent(WindowEvent.const_169,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_193 != null)
                  {
                     var_193(this,new WindowEvent(WindowEvent.const_667,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!_disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_692:
                  _loc2_ = _window.findChildByName(const_692) as IInteractiveWindow;
                  break;
