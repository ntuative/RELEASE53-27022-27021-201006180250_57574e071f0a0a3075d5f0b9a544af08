package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManager extends Component implements IHabboSoundManager
   {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _roomEngine.events.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_1034,onPlayEvent);
      }
      ...
      private function storeVolumeSetting() : void
      {
         if(_connection != null)
         {
            _connection.send(new SetSoundSettingsComposer(int(var_705 * 100)));
         }
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = var_1621.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_926:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1305:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1180:
               ...
               case HabboSoundTypesEnum.const_1028:
                  ...
                  break;
               case HabboSoundTypesEnum.const_929:
            ...
            var_1621.add(param1,_loc2_);
         }
         _loc2_.volume = var_705;
         _loc2_.play();
      }
   }
}
