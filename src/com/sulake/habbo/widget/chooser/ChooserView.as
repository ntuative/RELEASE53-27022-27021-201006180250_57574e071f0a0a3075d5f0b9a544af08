package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1459:uint = 0;
      ...
      private const const_1717:uint = 4.282169599E9;
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(var_726 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_726 % 2) ? uint(const_1459) : uint(const_1458);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1717;
            var_726 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1459) : uint(const_1458);
