package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1099:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_135,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_56,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_135,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_56,onDoorbellHandled);
      }
