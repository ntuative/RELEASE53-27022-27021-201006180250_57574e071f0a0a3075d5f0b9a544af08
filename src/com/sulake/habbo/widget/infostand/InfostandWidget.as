package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_2384:Array;
      
      private const const_1478:String = "infostand_user_view";
      
      private var var_338:InfoStandPetView;
      
      private var var_1214:InfoStandPetData;
      
      private var var_146:Timer;
      
      private var var_1000:InfoStandFurniView;
      
      private var var_412:InfostandFurniData;
      
      private var var_389:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1476:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1477:String = "infostand_pet_view";
      
      private const const_1479:String = "infostand_furni_view";
      
      private const const_1742:int = 3000;
      
      private var var_219:InfoStandUserView;
      
      private var var_469:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_1000 = new InfoStandFurniView(this,const_1479);
         var_219 = new InfoStandUserView(this,const_1478);
         var_338 = new InfoStandPetView(this,const_1477);
         var_389 = new InfoStandBotView(this,const_1476);
         var_469 = new InfostandUserData();
         var_412 = new InfostandFurniData();
         var_1214 = new InfoStandPetData();
         var_146 = new Timer(const_1742);
         var_146.addEventListener(TimerEvent.TIMER,onUpdateTimer);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_219.setTags(param1.tags,var_2384);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_282,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_608,onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_155,onUserTags);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_465,var_338.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_282,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_608,onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_155,onUserTags);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_58,HabboWindowStyle.const_40,HabboWindowParam.const_40,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      {
         var_338.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
