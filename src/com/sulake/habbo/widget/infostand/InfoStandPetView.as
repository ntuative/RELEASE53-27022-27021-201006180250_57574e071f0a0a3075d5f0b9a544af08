package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1727:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1719:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1726:String = "energy";
      
      private var var_1214:Map;
      
      private const const_1722:String = "nutrition";
      
      private var var_63:IItemListWindow;
      
      private const const_1723:uint = 3355443;
      
      private var var_224:IBorderWindow;
      
      private const const_1725:int = 158;
      
      private const const_1721:int = 16;
      ...
      private const const_1720:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_224 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_224 != null)
         {
            var_105 = var_224.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_224.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_224.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_105 == null || var_224 == null || var_63 == null)
         {
            return;
         }
         ...
         var_224.height = NaN;
         _window.width = Math.max(var_224.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1214.getValue(var_672) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1719,param1.level,param1.levelMax);
         updateStateElement(const_1720,param1.experience,param1.experienceMax);
         updateStateElement(const_1726,param1.energy,param1.energyMax);
         updateStateElement(const_1722,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_672 = param1.id;
         var_1214.remove(param1.id);
         var_1214.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_179 && var_179.getPetId() == var_672)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_379,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1725,const_1721,false);
         ...
         _loc5_.fillRect(_loc7_,const_1727);
         return _loc5_;
      }
