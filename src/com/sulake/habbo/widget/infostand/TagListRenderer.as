package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1713:int = 5;
      
      private const const_1714:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1316 != null && var_1316.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_835 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_835 += param1.height + const_1714;
            return fit(param1);
         }
         param1.offset(_offsetX,var_835);
         _offsetX += param1.width + const_1713;
         return true;
      }
