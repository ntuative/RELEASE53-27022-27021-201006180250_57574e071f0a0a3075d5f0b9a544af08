package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_581,param1));
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_420,eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_485,eventHandler);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_420,eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_485,eventHandler);
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_616,param1));
         removeRequest(param1);
      }
   }
}
