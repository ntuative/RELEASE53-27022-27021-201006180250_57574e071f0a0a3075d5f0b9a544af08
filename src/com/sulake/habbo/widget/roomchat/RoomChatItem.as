package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_373:int = 10;
      
      private static const const_1169:Number = 18;
      
      private static const const_1474:Number = 10;
      ...
      private var var_213:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1167,var_1168,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1167,var_812,var_1168,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1438 = param1.chatType;
         var_1167 = param1.userId;
         var_812 = param1.userName;
         var_1168 = param1.userCategory;
         _message = param1.text;
         var_1437 = param1.userX;
         var_213 = param1.userImage;
         var_1169 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_213 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_213.height);
         }
         ...
         if(var_213 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_213.width;
               _loc28_.height = var_213.height;
               _loc28_.bitmap = new BitmapData(var_213.width,var_213.height,true,0);
               _loc28_.bitmap.copyPixels(var_213,var_213.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_464 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_213.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1169 != 0)
            {
               _loc30_ = uint(var_1169 >> 16 & 255);
               _loc31_ = uint(var_1169 >> 8 & 255);
               _loc32_ = uint(var_1169 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_373;
            }
            else
            {
               _loc19_.text = var_812 + ":";
               _loc19_.y += var_464;
               _loc19_.width = _loc19_.textWidth + const_373;
               _width += _loc19_.textWidth + const_373;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1438 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_812);
            }
            else if(var_1438 == RoomWidgetChatUpdateEvent.const_262)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_812);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_373 + _loc20_.textWidth + const_528;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1167,var_1168,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1167,var_1168,_roomId,_roomCategory,param1);
      }
