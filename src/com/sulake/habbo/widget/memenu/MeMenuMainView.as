package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_166[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_166[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_166)
         {
            _loc6_ = var_166[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         var_166["rooms_icon"] = ["gohome_white","gohome_color"];
         var_166["dance_icon"] = ["dance_white","dance_color"];
         var_166["clothes_icon"] = ["clothes_white","clothes_color"];
         var_166["effects_icon"] = ["effects_white","effects_color"];
         var_166["badges_icon"] = ["badges_white","badges_color"];
         var_166["wave_icon"] = ["wave_white","wave_color"];
         var_166["hc_icon"] = ["_white","_color"];
         var_166["settings_icon"] = ["settings_white","settings_color"];
         var_166["credits_icon"] = ["credits_white","credits_color"];
         var_166["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_954);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1005));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_765);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1007));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_255);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_842));
               _widget.hide();
               break;
            case "settings":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "HabboRoomWidgetLib_memenu_settings_slider_button";
               if(false && _loc4_)
               {
