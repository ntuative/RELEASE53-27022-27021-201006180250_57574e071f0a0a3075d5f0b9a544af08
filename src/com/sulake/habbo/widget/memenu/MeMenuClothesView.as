package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.addEventListener(WindowEvent.const_277,onChildResized);
         _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_356,_window));
      }
      ...
      public function dispose() : void
      {
         if(_widget && false)
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_717));
         }
         _widget = null;
         if(false)
         {
