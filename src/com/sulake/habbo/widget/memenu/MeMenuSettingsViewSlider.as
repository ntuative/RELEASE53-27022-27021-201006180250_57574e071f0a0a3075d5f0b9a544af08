package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_914:MeMenuSettingsView;
      ...
      private var var_754:Number = 0.0;
      ...
      {
         if(param1.type != WindowEvent.const_503)
         {
            return;
         }
         var_914.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_632 != null)
            {
               ...
               var_1605 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1605 * (Number(param1 - var_754) / (var_1094 - var_754)));
      }
      ...
      {
         return param1 / var_1605 * (var_1094 - var_754) + var_754;
      }
   }
}
