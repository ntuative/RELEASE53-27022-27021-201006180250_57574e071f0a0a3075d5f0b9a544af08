package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_934:IWindow;
      
      private var var_932:IWindow;
      ...
      {
         super();
         var_178 = new Timer(1000);
         var_178.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_932 = _window.findChildByName("effect_hilite");
            var_932.visible = false;
         }
         var_933 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_934 = _window.findChildByName("loader_bar");
         if(var_934 != null)
         {
            var_421 = var_934.width;
            var_178.start();
            onUpdate();
         }
         if(false)
      ...
      public function dispose() : void
      {
         ...
         {
            var_178.stop();
            var_178.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_178 = null;
         }
         _container = null;
         if(_window != null)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_933 != null)
         {
            var_933.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_933.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
