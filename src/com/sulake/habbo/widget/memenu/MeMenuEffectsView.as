package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_980:Number = 55;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_675,param1.effect.type));
         }
         else
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_593,param1.effect.type));
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "moreEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1020));
               break;
            case "hideEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_629));
               break;
            default:
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            var_673.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_980;
            _loc2_++;
         }
         _loc4_ = 0;
         _loc5_ = 0 * const_980;
