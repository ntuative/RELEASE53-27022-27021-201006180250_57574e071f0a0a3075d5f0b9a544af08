package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_636:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1419:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_35 = const_1419;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_539,_id));
                     break;
