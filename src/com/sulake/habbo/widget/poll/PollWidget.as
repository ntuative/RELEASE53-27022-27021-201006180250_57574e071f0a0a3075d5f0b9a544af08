package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_131,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_64,showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_117,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_131,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_64,showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_117,showPollContent);
      }
