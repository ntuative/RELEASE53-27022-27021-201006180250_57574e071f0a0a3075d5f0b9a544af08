package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1072:int = 40;
      ...
      private var var_421:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1042 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1814 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1815 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_715 = new Timer(1000,1);
         var_715.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_850 = new Timer(5000,1);
         var_850.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_58,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_149,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_48,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_116,onInputChanged);
         _window.addEventListener(WindowEvent.const_503,onWindowMoved);
         var_1241 = true;
         var_126 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1816 = _loc2_.width + const_528 + _loc6_.width + const_1071;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1072,_loc8_.width) + const_528);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1042 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_126 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_421);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_421);
         }
