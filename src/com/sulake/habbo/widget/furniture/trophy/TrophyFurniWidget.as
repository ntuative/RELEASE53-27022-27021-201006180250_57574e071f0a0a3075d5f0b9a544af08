package com.sulake.habbo.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1464:Array = new Array("gold","silver","bronze");
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.const_716,onObjectUpdate);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.const_716,onObjectUpdate);
