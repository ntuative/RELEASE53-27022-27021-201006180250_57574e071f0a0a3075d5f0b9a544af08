package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_582,var_897);
      ...
      {
         hideInterface();
         var_897 = param1.objectId;
         var_1327 = param1.creditValue;
         showInterface();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_730,onObjectUpdate);
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1327));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_58,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1067,const_1070,2,2),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_730,onObjectUpdate);
      }
   }
}
