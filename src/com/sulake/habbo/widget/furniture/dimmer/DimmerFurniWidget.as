package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1065:Array = new Array(int(76.5),int(76.5));
      
      private static const const_1064:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_562,onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_691,onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         var_1901 = param1.presetId;
         var_1036 = param1.effectId;
         _color = param1.color;
         var_1037 = param1.brightness;
         if(_view != null)
         {
            _view.update();
         }
         if(!validateBrightness(var_1037,var_1036))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(_color,var_1037,var_1036 == 2);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var_842 = param1.selectedPresetId - 1;
         _presets = new Array();
         var _loc2_:int = 0;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(_color,var_1037,var_1036 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_562,onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_691,onHide);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:DimmerFurniWidgetPresetItem = _presets[var_842] as DimmerFurniWidgetPresetItem;
