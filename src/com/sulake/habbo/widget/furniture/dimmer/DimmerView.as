package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_388:DimmerViewAlphaSlider;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_251.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_251.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1067,const_1070,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_388 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_251 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_251.numTabItems)
         {
            _loc6_ = var_251.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_251.selector.getSelected();
         return var_251.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_388 != null)
         {
            var_388.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1183 = _loc2_.light;
         if(var_388 != null)
         {
            var_388.setValue(var_1183);
         }
         var_439 = colors.indexOf(_loc2_.color);
         if(var_574 != null)
         {
            var_574.setSelectedColorIndex(var_439);
         }
