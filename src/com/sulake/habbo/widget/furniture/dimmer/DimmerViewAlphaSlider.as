package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_94 && param1.type != WindowMouseEvent.const_436)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1605 * (var_1094 - var_754)) + var_754;
      }
   }
}
