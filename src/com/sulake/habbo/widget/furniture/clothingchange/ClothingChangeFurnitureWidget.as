package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_774:String = "Girl";
      
      private static const const_775:String = "Boy";
      ...
      private var var_604:IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_352,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_843,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_321,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_352:
               showGenderSelectionInterface(param1);
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_321:
               hideEditorInterface();
         }
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1839 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_58,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_352,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_843,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_321,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_100,true);
         var_604 = _loc4_;
         var_604.offset(100,100);
         var _loc6_:IWindow = var_604.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_357,param1,var_165,var_1839,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_604 != null)
         {
            _loc1_ = var_604 as IFrameWindow;
            if(_loc1_ != null)
            {
