package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_409,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_412,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_493,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_388,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_409,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_412,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_493,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_388,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_67:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_412:
               if(!var_252)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_493:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_388:
               if(!var_252)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_409:
               if(!var_252)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_252 || var_165 == -1 || !_controller)
         {
            return;
         }
         var_252 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_697,var_165);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_58,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1067,const_1070,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_212 != null)
         {
            _loc4_.caption = var_212;
         }
