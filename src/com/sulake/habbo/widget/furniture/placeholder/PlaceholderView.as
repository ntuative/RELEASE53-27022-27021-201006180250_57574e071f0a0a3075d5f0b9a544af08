package com.sulake.habbo.widget.furniture.placeholder
{
   ...
   public class PlaceholderView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("habbohelp_window","",HabboWindowType.const_58,HabboWindowStyle.const_40,0 | 0,new Rectangle(-300,300,10,10),null) as IWindowContainer;
