package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1407 || var_1626 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1627 == 0 || _loc1_ - var_1627 > var_1626)
         {
            if(_connection != null)
            {
      ...
      {
         var_1407 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1626 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
