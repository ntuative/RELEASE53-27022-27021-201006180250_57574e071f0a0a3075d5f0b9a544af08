package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_360);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_611);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_991);
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.const_140:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_98:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_98,param2,param3,_loc4_,_loc6_));
                  break;
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_461:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1227));
               break;
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_38 && _loc3_.typeId == RoomObjectTypeEnum.const_238)
               {
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_68)
         {
            ...
            if(_loc12_ != _loc10_)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_451,param2,param3,-1,RoomObjectCategoryEnum.const_215));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_360);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_401);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_271:
            ...
            case RoomObjectRoomAdEvent.const_381:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_341:
               _loc7_ = "null";
               break;
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_494:
               ...
               break;
            case RoomObjectMouseEvent.const_463:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_1046,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            if(wasSelected)
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_391));
            }
            else
            {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_470:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_453:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_360);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_401);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      {
         var _loc3_:Map = var_601.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_601.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_601.add(param1,_loc4_);
         }
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_391);
               }
               else
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_189:
            ...
            case RoomObjectMoveEvent.const_378:
               ...
               break;
            case RoomObjectMoveEvent.const_489:
            ...
            case RoomObjectRoomAdEvent.const_323:
               ...
               break;
            case RoomObjectRoomActionEvent.const_470:
            case RoomObjectRoomActionEvent.const_1000:
            case RoomObjectRoomActionEvent.const_453:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_464:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1034));
               break;
            case RoomObjectFurnitureActionEvent.const_407:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1410));
               break;
            case RoomObjectFurnitureActionEvent.const_411:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_865));
         }
