package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1100:int = -1.0E9;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1012,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_622);
         var _loc8_:int = 0;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_88.initializeTileMap(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc20_ < _loc7_)
            {
               ...
               var_88.setTileHeight(_loc20_,_loc15_,_loc21_);
               _loc20_++;
            }
            _loc15_++;
         }
         if(!_loc13_)
         {
            var_88.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_);
         }
         ...
         var_88.initializeFromTileData(_loc16_);
         if(!_loc13_)
         {
            var_88.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_ + var_88.wallHeight);
         }
         _loc6_.scale = _loc3_.scale;
         _loc6_.initialize(_loc7_,_loc8_,var_88.floorHeight);
         ...
         while(_loc17_ >= 0)
         {
            ...
            while(_loc23_ >= 0)
            {
               _loc6_.setTileHeight(_loc23_,_loc17_,var_88.getTileHeight(_loc23_,_loc17_));
               _loc23_--;
            }
            _loc17_--;
         }
         var _loc18_:XML = var_88.getXML();
         var _loc19_:XML = <dimensions minX="{var_88.minX}" maxX="{var_88.maxX}" minY="{var_88.minY}" maxY="{var_88.maxY}"/>;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_837:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_884:
                     _loc10_ = "std";
               }
