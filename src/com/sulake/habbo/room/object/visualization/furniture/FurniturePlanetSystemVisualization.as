package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_971);
      ...
      {
         if(param1 < var_622.length)
         {
            return var_622[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_237 != null)
         {
            ...
            {
               _loc2_ = var_237[_loc3_];
               _loc2_.update(var_622,var_2000,param1);
               _loc3_++;
            }
