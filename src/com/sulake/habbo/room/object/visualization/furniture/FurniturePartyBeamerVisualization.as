package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_771:int = 15;
      
      private static const const_1086:int = 2;
      
      private static const const_365:int = 2;
      
      private static const const_770:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1052[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1054[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1052 = new Array();
         var_1052.push(Math.random() * _loc2_ * 1.5);
         var_1052.push(Math.random() * _loc2_ * 1.5);
         var_1053 = new Array();
         var_1053.push(1);
         var_1053.push(-1);
         var_1055 = new Array();
         var_1055.push(const_1086);
         var_1055.push(const_1087);
         var_1054 = new Array();
         var_1054.push(getRandomAmplitudeFactor());
         var_1054.push(getRandomAmplitudeFactor());
      }
