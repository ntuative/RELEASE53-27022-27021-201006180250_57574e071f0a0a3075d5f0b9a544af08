   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_111 != null)
         {
            ...
            {
               _loc2_ = var_111.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc5_:AnimationLayerData = var_111.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc3_:AnimationLayerData = var_111.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
