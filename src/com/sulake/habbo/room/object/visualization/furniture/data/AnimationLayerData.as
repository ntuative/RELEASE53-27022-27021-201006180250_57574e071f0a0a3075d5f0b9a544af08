package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < var_217.length)
         {
            _loc2_ = var_217[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1554)
         {
            _loc4_ = param1 / var_387;
            param1 %= var_387;
            if(var_1452 > 0 && _loc4_ >= var_1452 || var_1452 <= 0 && var_387 == 1)
            {
               param1 = var_387 - 1;
               _loc3_ = true;
            }
            ...
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < var_217.length)
            {
               _loc2_ = var_217[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_217[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_217.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_217[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
