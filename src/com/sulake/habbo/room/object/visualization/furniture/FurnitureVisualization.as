package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1443:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2418:int = -1;
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2418,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2251 != param1 || var_2254 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_2252 != param1 || var_2253 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2418 = _loc3_.getNumber(RoomObjectVariableEnum.const_248);
            ...
            var_1556 = _loc3_.getString(RoomObjectVariableEnum.const_308);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_302 != _loc3_.getUpdateID() || param1 != var_153 || param2 != var_2417)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_302 = _loc3_.getUpdateID();
            var_2417 = param2;
            return true;
         }
         return false;
