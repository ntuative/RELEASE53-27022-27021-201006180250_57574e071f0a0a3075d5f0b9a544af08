package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_104.length)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + var_1637;
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_360);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_401);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_611);
