package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1170:Number = 30;
      ...
      {
         var_813 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1345 = param3;
         var_2329 = param4 * 0 * 2 / 360;
         var_1686 = param5 * 0 * 2 / 360;
         _height = param6;
         var_987 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1345 * Math.cos(var_987 + var_1686);
         var _loc4_:Number = var_1345 * Math.sin(var_987 + var_1686);
         var _loc5_:Number = _height;
         var_813.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_813.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_813.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_813.add(param1);
         }
