package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_336:int = 1000;
      ...
      private var var_533:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_533 = var_280.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_533 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_280 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_280.length)
            {
               _loc1_ = var_280.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_280.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_280.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
