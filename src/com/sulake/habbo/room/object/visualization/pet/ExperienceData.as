package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      private var var_901:BitmapDataAsset;
      ...
      {
         super();
         var_901 = param1.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
      }
      ...
      public function setExperience(param1:int) : void
      {
         ...
         _image = (var_901.content as BitmapData).clone();
