package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_569:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_569 != null)
         {
            _loc2_ = var_569.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_1157,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_1157,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_1157,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_804[_loc6_ % 0] as IGraphicAsset;
