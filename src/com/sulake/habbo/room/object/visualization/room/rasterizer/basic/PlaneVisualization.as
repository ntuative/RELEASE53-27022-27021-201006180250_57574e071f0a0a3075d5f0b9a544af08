package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneVisualization
   {
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int = 0, param7:int = 0, param8:int = 0, param9:int = 0, param10:Number = 0.0, param11:Number = 0.0, param12:int = 0) : BitmapData
      {
         ...
         var _loc13_:int = 0;
         while(_loc13_ < var_111.length)
         {
            _loc14_ = var_111[_loc13_] as PlaneVisualizationLayer;
            _loc15_ = var_111[_loc13_] as PlaneVisualizationAnimationLayer;
            if(_loc14_ != null)
            {
      ...
      {
         if(param1 < 0 || param1 > var_111.length)
         {
            return false;
         }
         var _loc4_:* = var_111[param1] as IDisposable;
         if(_loc4_ != null)
         {
            _loc4_.dispose();
            _loc4_ = null;
      ...
      public function setLayer(param1:int, param2:PlaneMaterial, param3:uint, param4:int, param5:int = 0) : Boolean
      {
         ...
         var _loc6_:* = var_111[param1] as IDisposable;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
            _loc6_ = null;
      ...
      public function clearCache() : void
      {
         ...
         if(var_111 != null)
         {
            ...
            {
               _loc2_ = var_111[_loc1_] as PlaneVisualizationLayer;
               _loc3_ = var_111[_loc1_] as PlaneVisualizationAnimationLayer;
               if(_loc2_ != null)
               {
                  _loc2_.clearCache();
               }
      ...
      public function dispose() : void
      {
         ...
         if(var_111 != null)
         {
            ...
            while(_loc1_ < var_111.length)
            {
               _loc2_ = var_111[_loc1_] as IDisposable;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
