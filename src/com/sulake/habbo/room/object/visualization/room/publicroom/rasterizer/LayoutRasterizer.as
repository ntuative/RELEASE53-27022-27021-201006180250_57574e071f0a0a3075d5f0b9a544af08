package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1106:Point = null;
      
      private var var_531:Array;
      
      private var var_1107:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1105 = param1;
         var _loc3_:LayoutRasterizerData = var_39.getValue(var_769);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1367 = RoomObjectVariableEnum.const_985;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1367 = RoomObjectVariableEnum.const_894;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1105 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1105 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1105 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1105 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1367);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_443;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2139);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_769)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1107 = var_39.getValue(var_769);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_39.getValue(var_769);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1107.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = var_986.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1106.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1106.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_366.indexOf(_loc10_) >= 0 && var_530)
            {
               param1 = var_366.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_986.getAsset(var_529[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_531[param1];
               }
               var_366.splice(param1,1);
               var_529.splice(param1,1);
               var_531.splice(param1,1);
               if(false)
               {
                  var_530 = false;
               }
