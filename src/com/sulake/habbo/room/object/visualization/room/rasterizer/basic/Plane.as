package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_790:PlaneVisualization = null;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = var_330.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_790 = var_330.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_790 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_330 != null)
         {
            ...
            {
               _loc1_ = var_330.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
