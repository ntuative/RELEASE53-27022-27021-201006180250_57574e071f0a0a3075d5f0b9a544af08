package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_744:PlaneMaskVisualization = null;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_744 = var_437.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_744 = null;
      ...
      {
         if(var_437.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         var_437.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_437 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_437.length)
            {
               _loc1_ = var_437.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
