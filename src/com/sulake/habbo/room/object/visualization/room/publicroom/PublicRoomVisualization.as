package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc5_:String = _loc4_.getString(RoomObjectVariableEnum.const_346);
         var _loc6_:* = !Boolean(_loc4_.getNumber(RoomObjectVariableEnum.const_442));
         if(_loc5_ != "" && data != null)
         {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(data != null)
         {
            var_1193 = spriteCount;
            _loc2_ = object.getModel();
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_1042);
            ...
            {
               data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + var_1193));
               _loc4_++;
            }
            data.layoutRasterizer.initializeAds(var_1193,this);
         }
         var_1792 = true;
      }
