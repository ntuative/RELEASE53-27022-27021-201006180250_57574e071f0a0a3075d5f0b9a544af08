package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1356:int = const_342;
      ...
      public static const const_280:int = const_109;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_356[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1574 == const_109)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_355);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_355,var_24.width,var_355);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_24 != null)
            {
               if(var_24.width == param2 && var_24.height == param3 && Vector3d.isEqual(var_591,param4))
               {
                  if(param1 != null)
                  {
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_356.length)
         {
            _loc11_ = var_356[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_591 != null)
         {
            var_591.assign(new Vector3d());
         }
         var_355 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_356.length)
         {
            _loc2_ = var_356[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_356.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_356[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_356[param1] = _loc5_;
