package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1226:Number = 0.0;
      ...
      private var var_841:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_979;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_292,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_841);
         ...
         if(param6)
         {
            ...
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_841 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_742 = getFloorHeight(var_103);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_349 || param1 == var_348)
               {
                  _loc5_ = false;
                  _loc6_ = var_347;
                  while(_loc6_ < var_346)
                  {
               ...
               if(param2 == var_347 || param2 == var_346)
               {
                  _loc7_ = false;
                  _loc8_ = var_349;
                  while(_loc8_ < var_348)
                  {
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_186,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_186,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_186,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_186,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_186,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
