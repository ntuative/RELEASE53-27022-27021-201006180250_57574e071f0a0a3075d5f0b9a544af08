   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_511,_loc3_.postureType);
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc4_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_350,_loc4_.dirHead);
            return;
         }
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_507,Number(_loc8_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_990,Number(getTimer()));
            _loc2_.setNumber(RoomObjectVariableEnum.const_877,Number(_loc10_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1376,_loc11_.race);
            return;
         }
      }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_257,null);
            var_1150 = 0;
         }
         if(var_1152 > 0)
         {
