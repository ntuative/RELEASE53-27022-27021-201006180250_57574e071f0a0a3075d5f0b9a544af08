   ...
   public class FurnitureWindowLogic extends FurnitureMultiStateLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_.length() > 0)
         {
            ...
            {
               _loc4_ = _loc3_.@type;
               object.getModelController().setNumber(RoomObjectVariableEnum.const_828,1,true);
               object.getModelController().setString(RoomObjectVariableEnum.const_1004,_loc4_,true);
            }
         }
      }
   }
