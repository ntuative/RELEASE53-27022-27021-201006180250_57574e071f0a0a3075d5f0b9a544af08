package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_442,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_544,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_442,Number(false));
         var_870 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_967:
                  _loc2_.setString(RoomObjectVariableEnum.const_346,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_544,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_442,Number(true));
                  var_1118 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_840);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_443)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_544);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_271,_loc5_,_loc6_,_loc7_));
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_443)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_341,_loc5_,_loc6_));
               }
               break;
