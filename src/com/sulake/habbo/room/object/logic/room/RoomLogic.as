package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1540:int = 1500;
      
      private var var_1538:int = 255;
      
      private var var_1539:int = 255;
      
      private var var_1256:uint = 16777215;
      
      private var var_1056:uint = 16777215;
      
      protected var var_88:RoomPlaneParser = null;
      
      private var var_857:int = 0;
      
      private var var_1272:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_875,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_737,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_633,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_707,1);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_920,int(param1.bgOnly));
         var_1256 = _color;
         var_1538 = var_1272;
         var_1056 = _loc3_;
         var_1539 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_998:
               param2.setNumber(RoomObjectVariableEnum.const_633,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_856:
               param2.setNumber(RoomObjectVariableEnum.const_707,_loc3_);
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_437:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_205)
               {
                  _loc5_ = "null";
               }
               var_466.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_739:
               _loc4_ = var_466.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_466.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_898,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_735:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_640:
               param2.setString(RoomObjectVariableEnum.const_664,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_679:
               param2.setString(RoomObjectVariableEnum.const_566,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_857)
         {
            ...
            {
               _loc7_ = var_1256 >> 16 & 255;
               _loc8_ = var_1256 >> 8 & 255;
               _loc9_ = var_1256 & 255;
               _loc10_ = var_1056 >> 16 & 255;
               _loc11_ = var_1056 >> 8 & 255;
               _loc12_ = var_1056 & 255;
               _loc13_ = (_loc2_ - var_857) / var_1540;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1538 + (var_1539 - var_1538) * _loc13_;
               _color = _loc3_;
               var_1272 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_737,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1345,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1416,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1387,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_186)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_150 || _loc13_ == RoomPlaneData.const_292)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
