package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1168:String = "bus_oviopen_hidden";
      
      private static const const_1167:String = "goawaybus";
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1166:
                  case const_1168:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_453,0,_loc4_,_loc5_);
               }
         }
