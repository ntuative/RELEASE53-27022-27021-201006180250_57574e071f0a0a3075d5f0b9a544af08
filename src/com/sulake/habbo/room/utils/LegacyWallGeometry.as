package com.sulake.habbo.room.utils
{
   ...
   public class LegacyWallGeometry implements IDisposable
   {
      ...
      private static const const_781:String = "l";
      ...
      public function getOldLocation(param1:IVector3d, param2:Number) : Array
      {
         ...
         if(param2 == 90)
         {
            ...
            _loc5_ = Number(var_150 / 2 - (param1.y - _loc4_ + 0.5) * Number(var_150 / 2));
            _loc6_ = Number((_loc8_ - param1.z) * Number(var_150 / 2) + (var_150 / 2 - _loc5_) / 2);
            _loc7_ = const_781;
         }
         else
         {
            ...
            _loc4_ = Number(Math.floor(param1.y - 0.5));
            _loc8_ = Number(getTileHeight(_loc3_,_loc4_));
            _loc5_ = Number((param1.x + 0.5 - _loc3_) * Number(var_150 / 2));
            _loc6_ = Number((_loc8_ - param1.z) * Number(var_150 / 2) + _loc5_ / 2);
      ...
      public function getLocationOldFormat(param1:Number, param2:Number, param3:String) : IVector3d
      {
         ...
         while(_loc4_ < _width)
         {
            ...
            {
               if(getTileHeight(_loc4_,_loc5_) <= var_742)
               {
                  _loc8_ = _loc4_ - 1;
                  _loc9_ = _loc5_;
               ...
               if(getTileHeight(_loc4_,_loc5_ + 1) <= var_742)
               {
                  _loc8_ = _loc4_;
                  _loc9_ = _loc5_;
      ...
      public function getLocation(param1:int, param2:int, param3:int, param4:int, param5:String) : IVector3d
      {
         ...
         if(param1 == 0 && param2 == 0)
         {
            ...
            if(param5 == DIRECTION_RIGHT)
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  {
                     if(getTileHeight(_loc7_,_loc6_) <= var_742)
                     {
                        if(_loc6_ - 1 < param2)
                        {
                           param1 = _loc7_;
         ...
         if(param5 == DIRECTION_RIGHT)
         {
            _loc8_ += param3 / Number(var_150 / 2) - 0.5;
            _loc9_ += 0.5;
            _loc10_ -= (param4 - param3 / 2) / Number(var_150 / 2);
         }
         else
         {
            _loc9_ += (var_150 / 2 - param3) / Number(var_150 / 2) - 0.5;
            _loc8_ += 0.5;
            _loc10_ -= (param4 - (var_150 / 2 - param3) / 2) / Number(var_150 / 2);
         }
