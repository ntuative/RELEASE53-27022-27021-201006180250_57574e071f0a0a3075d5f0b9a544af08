package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_521:String = "room";
      ...
      private static const const_801:String = "overlay";
      ...
      private var var_27:IRoomObjectFactory = null;
      
      private var var_67:RoomObjectEventHandler = null;
      
      private var var_775:RoomMessageHandler = null;
      
      private var var_774:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_775 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_67 != null)
         {
            ...
            {
               return var_67.deleteWallItem(var_119,var_120,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_323.length; _loc2_++)
         {
            _loc3_ = var_323.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_651) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_572) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_558) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_701) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_112);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_67.modifyWallItemData(var_119,var_120,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_27 != null)
         {
            var_27.release(new IIDRoomObjectFactory());
            var_27 = null;
         }
         if(var_418 != null)
         {
            var_418.release(new IIDRoomObjectVisualizationFactory());
            var_418 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_774 != null)
         {
            var_774.release(new IIDRoomRendererFactory());
            var_774 = null;
         }
         ...
         if(var_323 != null)
         {
            ...
            {
               _loc2_ = var_323.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_622);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_550);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_728);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_984);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_828) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1004);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_437,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_739,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_585,var_119,var_120,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            return var_67.modifyRoomObject(var_119,var_120,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_735,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_640,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_679,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_261);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_68);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_67 != null)
         {
            var_67.handleRoomObjectEvent(param1,var_119,var_120);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_364;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_248,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_829,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_952,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1016,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_259,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_756,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_27 == null || var_418 == null || var_41 == null || var_774 == null || _communication == null || _habboConfiguration == null || !var_2162)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_298,RoomObjectCategoryEnum.const_68);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1350,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_119,var_120));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_800,RoomObjectCategoryEnum.const_261);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1372);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1372);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_418 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_418;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_219,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_494,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_463,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_189,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_580,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_141,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_126,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_136,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_129,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_140,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_98,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_512,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_460,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_430,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_464,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_407,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_411,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_461,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_63,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_378,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_489,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_271,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_381,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_341,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_323,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_470,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_1000,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_453,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_481,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_538) != 0)
         {
            return false;
         }
         if(var_67 != null)
         {
            return var_67.initializeRoomObjectInsert(var_119,var_120,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_536 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_542,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_259,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_856,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_998,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_248));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_408);
                     break;
                  case RoomObjectCategoryEnum.const_38:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_160);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_350);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_603)
         {
            var_2162 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_248,_loc10_,false);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_259,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_275.events.addEventListener(AdEvent.const_394,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_801) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_323.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_598,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_774 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_536 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_520);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_520,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_248,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_408,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_160,param2);
               break;
            case RoomObjectCategoryEnum.const_68:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_186,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_292,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_744,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_664,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_566,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_437,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1110.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1002,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_799,RoomObjectCategoryEnum.const_261);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1623 - _loc12_.width / 2;
               _loc11_.y = var_1624 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_451,var_119,var_120,-1,RoomObjectCategoryEnum.const_215));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_298,const_521);
                  var_67.handleRoomObjectEvent(_loc14_,var_119,var_120);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1372);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1623 - _loc6_.data.width / 2;
               _loc11_.y = var_1624 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_346,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_985,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_894,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_967,RoomObjectVariableEnum.const_346,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_323.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_323.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_27 = param2 as IRoomObjectFactory;
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_603,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_67 != null)
         {
            var_67.cancelRoomObjectInsert(var_119,var_120);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_520);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1002);
               ...
               _loc13_ = var_1110.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_120,const_298,RoomObjectCategoryEnum.const_68,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1042,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_538,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_840,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_298,const_521,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_538,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_622,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_651,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_558,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_572,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_701,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_992,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_735,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_640,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_679,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_437,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_205);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_550,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_728,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_550,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_728,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_984,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_799,const_1139,RoomObjectCategoryEnum.const_261);
         _loc7_.createRoomObject(const_800,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_261);
         return _loc7_;
      }
