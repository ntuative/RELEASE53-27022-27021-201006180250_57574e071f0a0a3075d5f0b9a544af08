   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < var_228.length)
         {
            ...
            if(_loc1_ + HabboNotificationItemView.const_686 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_686 + const_514;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_1837,var_451,_toolbar);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_686 < 540;
      }
   }
}
