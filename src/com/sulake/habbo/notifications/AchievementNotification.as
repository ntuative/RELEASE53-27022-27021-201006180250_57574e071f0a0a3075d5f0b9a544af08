package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_212 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2310 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_212);
      ...
      public function dispose() : void
      {
         if(var_364 != null)
         {
            var_364.events.removeEventListener(BadgeImageReadyEvent.const_128,onBadgeImageReady);
            var_364 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_810,var_2310);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_810,var_810));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_810,var_810));
         _localizations.registerParameter(param1,"level",var_1873.toString());
         _localizations.registerParameter(param1,"name",var_364.userName);
         _localizations.registerParameter(param1,"realname",var_364.realName);
      }
   }
}
