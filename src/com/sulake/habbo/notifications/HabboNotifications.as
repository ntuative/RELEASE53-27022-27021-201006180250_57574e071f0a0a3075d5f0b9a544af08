package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1132:String = "badges";
      
      private static const const_1129:String = "pet_inventory";
      
      private static const const_1136:String = "pixelbalance";
      
      private static const const_1130:String = "credits";
      
      private static const const_1131:String = "inventory";
      
      private static const const_1134:String = "friendlist";
      
      private static const const_1133:String = "selectfurni";
      
      private static const const_1135:String = "selectbadge";
      ...
      private var var_636:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_446:HabboNotificationViewManager;
      
      private var var_760:ClubEndingNotification;
      ...
      private var var_759:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_917);
         }
         var _loc6_:Map = var_917["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1327);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_759 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_924)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_636)
         {
            var_636.release(new IIDHabboToolbar());
            var_636 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_84:
               ...
               break;
            case CatalogPageMessageProductData.const_230:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2107)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1037);
            var_2107 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1132:
               if(var_11 != null)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_256);
               }
               break;
            case const_1135:
               break;
            ...
            case const_1129:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_157);
               }
               break;
            case const_1133:
               break;
      ...
      {
         if(param1 != null && this.var_446 != null)
         {
            var_446.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1037,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_638.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_54);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_35,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_45);
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_866,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_169 || param2.type == WindowEvent.const_667)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_446.isSpaceAvailable() && false)
         {
            var_446.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_1096.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_638.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_54);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_364);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_364.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc9_ = var_364.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_364.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1317,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_638.createAvatarImage(param2,AvatarScaleType.const_54);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1096.push(_loc8_);
         return var_1096.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1361)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_760 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_636 = IHabboToolbar(param2);
         var_636.events.addEventListener(HabboToolbarEvent.const_89,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_364.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_951);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_951);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_89)
         {
            ...
            var_446 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_917["styles"],var_917["view"],var_636);
            ...
            registerUpdateReceiver(var_446,1);
            registerUpdateReceiver(this,2);
            var_364.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
            var_636.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
