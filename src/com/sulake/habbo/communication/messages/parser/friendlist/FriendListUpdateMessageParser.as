package com.sulake.habbo.communication.messages.parser.friendlist
{
   ...
   public class FriendListUpdateMessageParser implements IMessageParser
   {
      ...
      {
         this.var_2382 = new Array();
         this._removedFriendIds = new Array();
         this.var_2381 = new Array();
         this.var_2383 = new Array();
         return true;
      }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_2382.push(new FriendCategoryData(param1));
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            {
               this.var_2383.push(new FriendData(param1));
            }
            else if(_loc5_ == 1)
            {
               this.var_2381.push(new FriendData(param1));
            }
            _loc3_++;
         }
         return true;
