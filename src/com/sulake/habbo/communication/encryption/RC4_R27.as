package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1108:int = 52;
      
      private static const WEDGIE_BYTE_MASK:uint = 64;
      
      private static const const_1109:String = "mWxFRJnGJ5T9Si0OMVvEBBm8laihXkN8GmH6fuv7ldZhLyGRRKCcGzziPYBaJom";
      ...
      private static const const_791:String = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
       
      
      private var var_1997:PseudoRandom;
      
      private var var_1575:IEncryption;
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ByteArray = CryptoTools.stringToByteArray(const_1109);
         var _loc4_:int = 0;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(var_1575 != null)
         {
            ...
            _loc5_ = var_1575.encipher(_loc7_,true);
