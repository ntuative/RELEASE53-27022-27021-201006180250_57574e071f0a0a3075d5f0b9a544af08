package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_610:Function;
      
      private var _window:IWindowContainer;
      
      private var var_727:IAssetLibrary;
      
      private var var_866:uint = 0;
      
      private var var_611:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_727.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_502));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_727.loadAssetFromFile("hotel_view_banner_" + var_866,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_766));
            }
            var_611 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_727.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
