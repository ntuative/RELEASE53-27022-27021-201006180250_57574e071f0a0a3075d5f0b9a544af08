package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_549:String = "InitConnection";
      ...
      {
         var_177.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_177.shockwaveClientUrl = var_118.shockwaveClientUrl;
         var_177.ssoTicket = var_118.ticket;
         var_118.removeEventListener(SSOTicket.const_331,onParsedTicketSuccess);
         var_118.removeEventListener(SSOTicket.const_296,onParsedTicketFailure);
         var_118 = null;
         dispatchEvent(new Event(const_549));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1462,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_177 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_177.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_114,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_177.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1462,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_177.habboConfiguration.getKey("use.sso","false") == "HabboRoomWidgetLib_memenu_settings_slider_button")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_177.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_177.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_177.habboCommunication.habboWebLogin(name,password);
         var_118 = new SSOTicket(var_177.assets,_loc2_,_loc1_);
         var_118.addEventListener(SSOTicket.const_331,onParsedTicketSuccess);
         var_118.addEventListener(SSOTicket.const_296,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_177.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_177.windowManager.buildFromXML(_loc3_.content as XML);
