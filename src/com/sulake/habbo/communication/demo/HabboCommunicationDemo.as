package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_183:HabboHotelView;
      ...
      private var var_2182:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1636:ILogger;
      
      private var var_1385:String;
      
      private var var_2184:String;
      
      private const const_1462:String = "fuselogin";
      
      private var var_336:ICoreCommunicationManager;
      
      private var var_453:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2183)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_779 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_779);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_182);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_1119 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_246);
         param1.send(new VersionCheckMessageComposer(401,var_1385,var_2184));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1462,"/");
      ...
      {
         var _loc4_:IConnection = var_61.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_453.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_453.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2182);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1462,"/");
      ...
      {
         var_779 = _habboConfiguration.getKey("sso.ticket",null);
         var_1385 = _habboConfiguration.getKey("flash.client.url","");
         var_2184 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_183 == null)
         {
            var_183 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_779 != null)
         {
            var_61.mode = HabboConnectionType.const_392;
            var_61.initConnection(HabboConnectionType.const_266);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1636 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_61.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_621);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2182 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_61.mode)
         {
            case HabboConnectionType.const_392:
               ...
               var_1120 = _loc4_;
               var_183.loadBannerImage(_loc7_ + "?token=" + var_1120,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1050:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1262:
               var_653 = generateRandomHexString(30);
               var_453 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_453.init(var_653);
               _loc8_ = var_453.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_183.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1120);
         ...
         var_453 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_453.init(_loc14_);
            _loc15_ = var_453.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_61.mode = HabboConnectionType.const_1050;
            }
         }
         var_61.initConnection(HabboConnectionType.const_266);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_212);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_174,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_107,onRoomSessionEnded);
      }
