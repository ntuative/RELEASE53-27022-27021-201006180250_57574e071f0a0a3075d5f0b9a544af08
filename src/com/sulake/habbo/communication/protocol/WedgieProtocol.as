package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1398:uint = 2;
       
      
      private var var_958:IProtocolDecoder;
      
      private var var_1140:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1140 = new WedgieEncoder();
         var_958 = new WedgieDecoder();
      }
