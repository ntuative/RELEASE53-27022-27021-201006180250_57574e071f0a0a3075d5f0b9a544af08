package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_821:FaqCategory;
      ...
      {
         super();
         var_822 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_821 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_145 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_822.hasItem(param1))
         {
            var_822.getItem(param1).method_1 = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).method_1 = param2;
         }
         if(var_821.hasItem(param1))
         {
            var_821.getItem(param1).method_1 = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_145.length)
         {
            ...
            {
               _loc4_.getItem(param1).method_1 = param2;
            }
            _loc3_++;
         }
      }
