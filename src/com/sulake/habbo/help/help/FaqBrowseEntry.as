package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_241.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_241.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_241.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_241.method_1);
         }
         if(_loc3_ != null)
         {
      ...
      private function getNextItem() : FaqItem
      {
         ...
         var _loc2_:FaqCategory = var_241.category;
         if(_loc2_ == null)
         {
            return null;
         }
