package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_374:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_823 == null || _loc3_ < 0 || _loc3_ >= var_823.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_823[_loc3_];
            main.showUI(HabboHelpViewEnum.const_750);
            main.tellUI(HabboHelpViewEnum.const_750,null);
         }
      }
   }
}
