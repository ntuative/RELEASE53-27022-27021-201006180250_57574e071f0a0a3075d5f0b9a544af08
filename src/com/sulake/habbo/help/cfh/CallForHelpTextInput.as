package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1110:int = 30;
      
      private static const const_1068:int = 253;
      
      private static const const_1069:int = 10;
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "send":
               ...
               break;
            case "cancel":
               main.showUI(HabboHelpViewEnum.const_153);
               break;
            default:
