package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.HELP_ARROW,var_618));
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_173,HabboToolbarIconEnum.HELP);
         if(param1)
         {
