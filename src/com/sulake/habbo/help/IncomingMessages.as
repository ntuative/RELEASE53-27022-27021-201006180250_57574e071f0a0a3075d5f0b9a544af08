package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         _loc3_.storeAnswerText(_loc2_.questionId,_loc2_.method_1);
         var _loc4_:FaqItem = _loc3_.getItem(_loc2_.questionId);
         if(_loc4_ != null)
         {
            var_23.tellUI(HabboHelpViewEnum.const_231,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_260,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_153);
      }
      ...
      {
         var_23.showUI(HabboHelpViewEnum.const_343);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_447);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_594);
         var_23.tellUI(HabboHelpViewEnum.const_594,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_355)
            {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_726);
      }
