package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1553:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1276));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1553[var_1276]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
