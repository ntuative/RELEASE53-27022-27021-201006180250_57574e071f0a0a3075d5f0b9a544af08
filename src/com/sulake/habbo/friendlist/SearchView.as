package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_695:ITextFieldWindow;
      ...
      {
         var_695 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_695.procedure = onSearchInput;
         var_695.addEventListener(WindowKeyboardEvent.const_149,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_358.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_49.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_353,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_695.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
