package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_335:int = 100;
      ...
      {
         return Math.ceil(this.var_240.length / const_335);
      }
      ...
      {
         if(this.var_902 >= this.getPageCount())
         {
            this.var_902 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_240[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_240.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_902 + 1) * const_335,this.var_240.length);
      }
