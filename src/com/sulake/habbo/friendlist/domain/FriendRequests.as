package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_433:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_945;
         var_433.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_433.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_226.push(param1);
         var_433.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            if(false)
            {
               var_433.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
