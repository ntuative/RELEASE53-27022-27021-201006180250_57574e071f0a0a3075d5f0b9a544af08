package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1448:String = "noconvinfo";
      
      private static const const_1447:String = "messageinput";
      ...
      private var var_1230:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1230 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_1001 = IWindowContainer(var_15.content.findChildByName("main_content"));
         var_283 = IWindowContainer(var_15.content.findChildByName("footer"));
         var_1230.prepare(var_1001);
         var_15.procedure = onWindow;
         var_15.content.setParamFlag(HabboWindowParam.const_838,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1286,true);
         var_15.header.setParamFlag(HabboWindowParam.const_543,false);
         var_15.header.setParamFlag(HabboWindowParam.const_1013,true);
         var_15.content.setParamFlag(HabboWindowParam.const_543,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1013,true);
         var_15.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1229 = ITextWindow(var_15.findChildByName("info_text"));
         var_1229.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_283.y = Util.getLowestPoint(var_15.content);
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_871,this._friendList.tabs.findSelectedTab() != null);
         var_15.scaler.setParamFlag(HabboWindowParam.const_543,false);
         var_15.scaler.setParamFlag(HabboWindowParam.const_838,false);
         var_15.scaler.x = 0 - var_15.scaler.width;
         var_15.scaler.y = 0 - var_15.scaler.height;
         var_1511 = var_15.height;
         var_1510 = var_15.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1511 == -1 ? 0 : int(0 - var_1511);
         var _loc4_:int = var_1510 == -1 ? 0 : int(0 - var_1510);
