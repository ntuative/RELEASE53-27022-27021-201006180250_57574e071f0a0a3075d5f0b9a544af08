package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1446:String = "no_reqs_info";
       
      
      private var var_1493:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_306 && _loc4_.state != FriendRequest.const_332)
            {
               ...
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_56,_loc4_.requestId));
               }
            }
         }
      ...
      {
         var_1493 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1494 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1494.procedure = onDismissAllButtonClick;
         var_1493.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_306 && _loc4_.state != FriendRequest.const_332)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_278,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_945)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1493,_loc1_);
         setEnabled(var_1494,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_56,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_278,param1));
         }
      }
   }
}
