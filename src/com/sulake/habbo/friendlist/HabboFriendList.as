package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_146:String = "face";
      ...
      private var var_1634:OpenedToWebPopup;
      
      private var var_938:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_465:FriendListTabs;
      
      private var _localization:IHabboLocalizationManager;
      
      private var _view:FriendListView;
      
      private var var_147:IHabboMessenger;
      
      private var var_1635:AvatarSearchResults;
      ...
      private var var_2181:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_939:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2181 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_92 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1635 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_370.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_370.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_465.findTab(FriendListTab.const_91).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_370 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_92.addCategory(new FriendCategory(FriendCategory.const_1038,getText("friendlist.friends")));
         var_92.addCategory(new FriendCategory(FriendCategory.const_468,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_92.addFriend(new Friend(_loc4_));
         }
         var_465 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_542)
         {
         ...
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_147)
         {
            var_147.release(new IIDHabboMessenger());
            var_147 = null;
         }
         if(var_143)
         {
         ...
         if(var_938)
         {
            var_938.release(new IIDAvatarRenderManager());
            var_938 = null;
         }
         if(var_939)
         {
            var_939.release(new IIDHabboNotifications());
            var_939 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_652)
         {
            var_652.release(new IIDSessionDataManager());
            var_652 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_147 = param2 as IHabboMessenger;
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = var_92.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_146) as IBitmapWrapperWindow;
      ...
      {
         var_92.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_143.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboRoomWidgetLib_memenu_settings_slider_button";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_465.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_330));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1635.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_173,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_370.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_92.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_652.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_652.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_370.limit)
         {
            var_370.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_465.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_938.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_370.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_465.findTab(FriendListTab.const_91);
      ...
      {
         return var_143.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1634 == null)
         {
            var_1634 = new OpenedToWebPopup(this);
         }
         var_1634.show(x,y);
      }
