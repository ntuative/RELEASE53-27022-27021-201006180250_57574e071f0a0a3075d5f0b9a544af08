package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         if("false" == var_143.getKey("use.default.localizations","false"))
         {
            _loc4_ = var_143.getKey("external.texts.txt","external_texts.txt");
            super.loadLocalizationFromURL(_loc4_);
         }
         var _loc3_:int = 1;
         while(var_143.keyExists("localization." + _loc3_))
         {
            _loc5_ = var_143.getKey("localization." + _loc3_,"");
            _loc6_ = var_143.getKey("localization." + _loc3_ + ".name","");
            _loc7_ = var_143.getKey("localization." + _loc3_ + ".url","");
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            (var_143 as Component).events.addEventListener(HabboConfigurationEvent.INIT,onConfigurationReady);
         }
      }
