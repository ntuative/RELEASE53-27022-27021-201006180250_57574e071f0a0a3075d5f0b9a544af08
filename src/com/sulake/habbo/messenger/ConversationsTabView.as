package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_1001 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_20.findChildByName("convo_bg"));
         _loc3_.bitmap = var_147.getButtonImage("convo_bg");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_147.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_147.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_147.conversations.startIndex > 0;
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         var_147.refreshButton(param1,param3,true,onTabClick,param2);
      }
      
      public function getTabCount() : int
      {
         return Math.floor(0 / var_1466);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_147.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_146 ? var_147.conversations.findConversation(param2.id) : var_147.conversations.openConversations[_loc3_ + var_147.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_147.conversations.setSelected(_loc4_);
         }
      ...
      {
         var_147.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboMessenger.const_146) as IBitmapWrapperWindow;
         ...
         {
            _loc3_.bitmap = var_147.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         return var_147.conversations.openConversations.length - var_147.conversations.startIndex > getTabCount();
      }
      ...
      {
         var _loc3_:IWindowContainer = var_1001.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
         refreshArrow(_loc3_,param1,param2);
         refreshTabBg(_loc3_,param1,!!param2 ? "tab_bg_next" : "tab_bg_unsel");
         var _loc4_:int = 0 % var_1466;
         _loc3_.width = var_1466 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = IWindowContainer(var_147.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
            var_1001.addChild(_loc3_);
         }
         hideChildren(_loc3_);
         if(param2 == null)
         {
         ...
         _loc3_.x = param1 * var_1466;
         _loc3_.width = var_1466;
         return false;
      }
   }
}
