package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_675:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_255:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_675.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_675.setSelected(_loc2_);
            var_255.openMessenger();
            var_255.refresh();
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_143.getKey("url.prefix",_loc2_);
      ...
      {
         var_675.addMessageAndUpdateView(param1);
         if(!var_255.isMessengerOpen())
         {
      ...
      {
         var_675 = new Conversations(new ConversationsDeps(this));
         var_255 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_173,HabboToolbarIconEnum.MESSENGER);
      ...
      {
         var_675.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_727,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_675.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_826,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_675.addMessageAndUpdateView(_loc3_);
      }
