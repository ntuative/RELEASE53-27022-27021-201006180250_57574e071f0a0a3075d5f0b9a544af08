package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private var var_433:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(false)
         {
            var_129[0].setSelected(true);
         }
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_764,0,var_433.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_433.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_433.getTabCount());
      ...
      {
         return var_433.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function closeConversation() : void
      {
         ...
         var _loc2_:int = var_129.indexOf(_loc1_);
         Util.remove(var_129,_loc1_);
         ...
         while(_loc2_ >= 0)
         {
            if(false)
            {
               var_129[_loc2_].setSelected(true);
               break;
            }
            _loc2_--;
         }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         var _loc2_:int = var_129.indexOf(param1);
         while(_startIndex + var_433.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_433.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_647,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_433.addMsgToView(_loc3_,param1);
         if(_loc2_ != var_129.length || _loc4_ != _loc3_.newMessageArrived)
         {
            var_433.refresh(false);
         }
      }
