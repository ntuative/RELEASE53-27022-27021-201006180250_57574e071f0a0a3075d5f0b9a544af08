package com.sulake.habbo.messenger
{
   ...
   public class Util
   {
      ...
      {
         return param1.createWindow(param2,param2,HabboWindowType.const_58,HabboWindowStyle.const_42,0 | (!!param5 ? HabboWindowParam.const_73 : 0),new Rectangle(param3,param4,600,600),null) as IWindowContainer;
      }
   }
}
