package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_551,RoomWidgetEcotronBoxOpenMessage.const_762,RoomWidgetEcotronBoxOpenedMessage.const_1352];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_551:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_762:
