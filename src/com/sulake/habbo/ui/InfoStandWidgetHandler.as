   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_155,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_143,onFigureUpdate);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_155,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_143,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1016);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_238)
               {
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_425);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_224)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_649);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1347;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_995;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_870;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1425);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_54,_loc18_);
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_35,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_35,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_54,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_648.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_54);
            var_648.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_35),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_649);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_118];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_359);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_379);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_267);
         _loc1_.push(RoomWidgetFurniActionMessage.const_627);
         _loc1_.push(RoomWidgetFurniActionMessage.const_654);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_617);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_564);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1208);
         _loc1_.push(RoomWidgetPetCommandMessage.const_559);
         _loc1_.push(RoomWidgetPetCommandMessage.const_740);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_118:
      ...
      public function dispose() : void
      {
         ...
         if(var_648 != null)
         {
            _loc1_ = var_648.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_648.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_495)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_359:
            ...
            case RoomWidgetUserActionMessage.const_556:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_891,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_662:
               ...
               break;
            case RoomWidgetUserActionMessage.const_379:
            ...
            case RoomWidgetUserActionMessage.const_465:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_617:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_564:
