package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_590);
         _loc1_.push(RoomWidgetChatTypingMessage.const_567);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_590:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_567:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_650,HabboToolbarIconEnum.CHATINPUT,param1));
         _container.events.dispatchEvent(new RoomWidgetChatInputDisplayEvent(RoomWidgetChatInputDisplayEvent.const_560,_container.sessionDataManager.isAnyRoomController));
      }
   }
}
