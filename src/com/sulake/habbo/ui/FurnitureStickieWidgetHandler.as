package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_658,RoomWidgetStickieSendUpdateMessage.const_635,RoomWidgetStickieSendUpdateMessage.const_448];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_658:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_879);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_570,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
                     _container.events.dispatchEvent(_loc11_);
                  }
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_448:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_635:
