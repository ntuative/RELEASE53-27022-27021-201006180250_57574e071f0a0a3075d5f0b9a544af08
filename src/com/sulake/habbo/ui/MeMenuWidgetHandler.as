package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_753:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_732:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_593:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_675:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_535:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_842)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_245,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_704:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1020:
                        _catalog.openCatalogPage(CatalogPageName.const_1228,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1007:
                        var_11.toggleInventoryPage(InventoryCategory.const_256);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1359:
            ...
            case RoomWidgetStopEffectMessage.const_668:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_900:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_957:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_656:
               ...
               break;
            case RoomWidgetToolbarMessage.const_575:
            ...
            case RoomWidgetToolbarMessage.const_690:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_500,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_356:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_390));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_591:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_625:
            ...
            case RoomWidgetStoreSettingsMessage.const_618:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_302,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_717:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_478));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_357:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_548));
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_108:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_108));
               break;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_602,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               ...
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_108,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_602,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_896,onAvatarEffectsChanged);
         ...
         if(false)
         {
            ...
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_108,onHelpTutorialEvent);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_761);
         _loc1_.push(RoomWidgetDanceMessage.const_753);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_732);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_593);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_675);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_629);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_704);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_535);
         _loc1_.push(RoomWidgetStopEffectMessage.const_668);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1370);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_957);
         _loc1_.push(RoomWidgetToolbarMessage.const_575);
         _loc1_.push(RoomWidgetToolbarMessage.const_690);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_356);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1255);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_940);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_656);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_677);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_591);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1233);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_625);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_618);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_717);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_357);
         return _loc1_;
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1043,HabboToolbarIconEnum.MEMENU);
