package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_587,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
