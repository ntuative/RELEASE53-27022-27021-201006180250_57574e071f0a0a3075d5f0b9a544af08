package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_688);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_581);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_616);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_122:
               ...
               break;
            case FriendRequestEvent.const_56:
            case FriendRequestEvent.const_278:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_688:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_581:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_616:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_56);
         _loc1_.push(FriendRequestEvent.const_278);
         return _loc1_;
      }
