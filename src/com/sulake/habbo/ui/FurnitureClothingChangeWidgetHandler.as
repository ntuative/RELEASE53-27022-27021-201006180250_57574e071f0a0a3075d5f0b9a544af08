package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_597,RoomWidgetClothingChangeMessage.const_357,RoomWidgetAvatarEditorMessage.const_356];
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_321);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_597:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_352,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_357:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_830);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1101;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_899);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1100;
                        }
                     }
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_241,AvatarEditorFigureCategory.const_672],true))
                     {
                        _loc11_ = 0;
                        _container.avatarEditor.loadAvatarInEditor(_loc10_,_loc9_,_loc11_);
                        _loc2_ = _loc4_.getString(RoomObjectVariableEnum.const_112);
                        if(_loc2_ == null)
                        {
                           _loc2_ = "";
                        }
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_352,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        _container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_356:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_321);
               _container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
