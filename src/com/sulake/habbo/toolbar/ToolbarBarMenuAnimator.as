package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1127:Number = 90;
      
      private static const const_798:int = 50;
      
      private static const const_1125:Number = 25;
      
      private static const const_1138:int = 50;
      
      private static const const_201:Boolean = true;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1109 = param2;
         var_646 = new Timer(const_1125);
         var_646.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_534.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_534.splice(_loc3_,1);
            var_535.splice(_loc3_,1);
         }
         var_535.push(param1.name);
         var_534.push(param2);
         param1.addEventListener(WindowEvent.const_503,windowEventListener);
         param1.addEventListener(WindowEvent.const_211,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_534[var_535.indexOf(param1)];
      }
      ...
      {
         return var_535[var_534.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_322[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_645[_loc3_] = new Array();
            }
            if(var_645[_loc3_].indexOf(param1) < 0)
            {
               var_645[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_798 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_798 || param1.desktop.height - param1.y < const_1138;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_535.length)
         {
            if(var_535[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_645[_loc3_].length)
                  {
                     repositionWindow(var_645[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
