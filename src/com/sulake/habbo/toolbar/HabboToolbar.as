package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_336.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_133,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1043,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_165,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_173,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_49,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_500,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_650,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_997,onHideWindowEvent);
         var_35 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_89));
      }
