package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1459:uint = 4.294967295E9;
      
      private const const_1458:uint = 4.293848814E9;
      
      private var var_922:int;
      
      private const const_1730:uint = 4.291613146E9;
      ...
      private var var_528:IWindowContainer;
      ...
      private const const_1729:int = 10;
      ...
      private var var_77:IPurchasableOffer;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_243.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_921;
               }
            }
            _loc4_++;
         }
      ...
      {
         if(this.var_77 == null || this.var_77.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = _catalog.getProductData(var_77.localizationId);
         ...
         switch(var_77.priceType)
         {
            ...
            case Offer.const_395:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_77.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_77.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_77.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_921,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1458) : uint(const_1459);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_467,var_77,var_1103);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_243.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_278) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_921);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_642[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_643[var_205]);
         _catalog.purchaseProductAsGift(var_467,var_77,var_1103,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = _catalog.getProductData(var_77.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = var_77.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(var_77 is Offer)
            {
               _loc10_ = var_77.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(var_77 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_84:
                  ...
                  break;
               case ProductTypeEnum.const_230:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1500 = _loc1_.stuffTypes;
            var_642 = _loc1_.boxTypes;
            var_643 = _loc1_.ribbonTypes;
            var_921 = var_1500[0];
            _boxIndex = var_642[0];
            var_205 = var_643[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_243.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_278) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_278);
         }
         var_278 = param1;
         if(var_278 < 0)
         {
            var_278 = _loc2_.numListItems - 1;
         }
         if(var_278 >= _loc2_.numListItems)
         {
            var_278 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_278) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_243 == null)
         {
            var_243 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_528 == null)
         {
            var_528 = createWindow("suggestion_list_item") as IWindowContainer;
            var_528.procedure = suggestionsEventHandler;
         }
         if(var_243 == null || var_528 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_243.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_528.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
