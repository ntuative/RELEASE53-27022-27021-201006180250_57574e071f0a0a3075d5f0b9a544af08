package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1312:IProductData;
      ...
      {
         super();
         var_1314 = param1.productType;
         var_1311 = param1.furniClassId;
         var_1077 = param1.extraParam;
         var_1078 = param1.productCount;
         var_1313 = param1.expiration;
         var_1312 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_84:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1077);
               break;
