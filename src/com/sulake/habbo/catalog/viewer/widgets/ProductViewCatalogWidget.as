package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1323:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_623 != null)
         {
            ...
            var_623.destroyGridItems();
         }
         if(var_1323 != null)
         {
            var_1323.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1416.text = "${" + _loc3_.name + "}";
            var_1417.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1416.text = "${" + _loc2_.localizationId + "}";
            var_1417.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_490:
                  _loc4_ = var_1322.clone();
                  if(var_623 != null)
                  {
                     var_623.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_623,var_1323,var_1321);
                  }
                  break;
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_230:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           _loc13_ = _loc12_.avatarRenderManager.createAvatarImage(_loc14_,AvatarScaleType.const_54);
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_45,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_293,AvatarAction.const_419);
                              _loc13_.appendAction(AvatarAction.const_389,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_35,true);
      ...
      {
         var_1416 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1417 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1576 = new Point(var_84.x,var_84.y);
         var_623 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1323 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_623 == null)
         {
         ...
         var_1322 = _loc2_.content as BitmapData;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_84 != null && true)
         {
            ...
            var_84.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_84.invalidate();
            var_84.x = var_1576.x;
            var_84.y = var_1576.y;
            if(param3 != null)
