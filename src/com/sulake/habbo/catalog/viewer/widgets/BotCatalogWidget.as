package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_331:IGridItem;
      
      protected var var_1017:IItemGridWindow;
      
      protected var var_1321:XML;
      
      private var var_1228:Map;
      
      private var var_707:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_1017 = _window.findChildByName("botGrid") as IItemGridWindow;
         var_1507 = new Map();
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = var_1507.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = var_1228.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1321) as IWindowContainer;
         var_1017.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1228.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            var_1507.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = var_1228.getValue(var_707.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc2_)
         {
            ...
            setPreviewImage(_loc2_.getImage(AvatarSetType.const_35,true));
            _loc2_.dispose();
         }
      }
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_707,page);
      }
      ...
      private function populateGridItems() : void
      {
         ...
         var_1321 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_707.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_707.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_707.localizationId);
