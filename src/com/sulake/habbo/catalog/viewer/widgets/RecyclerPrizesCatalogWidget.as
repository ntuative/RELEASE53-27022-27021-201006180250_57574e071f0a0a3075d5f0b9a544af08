package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1320:XML;
      
      private var var_331:IGridItem;
      
      private var var_1321:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_890:PrizeViewer;
      ...
      override public function init() : void
      {
         ...
         var_1320 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1320) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1321) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_890.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
