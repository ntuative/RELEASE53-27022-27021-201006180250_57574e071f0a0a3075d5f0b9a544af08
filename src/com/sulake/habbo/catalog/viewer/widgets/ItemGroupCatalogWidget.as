package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_639[var_1099] as Array;
      ...
      {
         var _loc2_:Offer = var_639[var_1099][var_2108];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_433 || _loc1_.pricingModel == Offer.const_472)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_84 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1098.indexOf(_loc5_) == -1)
                        {
                           var_1098.push(_loc5_);
                           var_639.push(new Array());
                        }
                        _loc6_ = var_1098.indexOf(_loc5_);
                        (var_639[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_639)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_639)
         {
            if(var_2108 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2108] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1099 = var_1017.getGridItemIndex(param1.view);
