package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_331:IWindowContainer;
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_331 != null)
         {
            _loc2_ = var_331.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1443 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_331 = null;
         for each(_loc1_ in var_1442)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1443) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_735.width,var_735.height,true,0);
               _loc3_.bitmap.copyPixels(var_735,var_735.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_882.width,var_882.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_734.width,var_734.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_734,var_734.rect,new Point(0,0),null,null,true);
