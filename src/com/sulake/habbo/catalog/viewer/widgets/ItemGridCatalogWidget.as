package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_331:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_695,activateScrollbar);
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_964 >= 0 && var_964 < page.offers.length)
            {
               _loc4_ = page.offers[var_964];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1657;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1657);
         }
      }
      
      override public function init() : void
      {
         var_1017 = _window.findChildByName("itemGrid") as IItemGridWindow;
