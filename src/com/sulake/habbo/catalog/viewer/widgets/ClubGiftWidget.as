package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_158:int = 31;
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_587.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = _controller.purse.pastClubDays > const_158 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _controller.purse.pastClubDays % const_158;
            _loc4_ = _controller.purse.pastClubDays / const_158;
         ...
         if(_loc6_)
         {
            _loc2_ = _controller.purse.pastVipDays > const_158 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = _controller.purse.pastVipDays % const_158;
            _loc4_ = _controller.purse.pastVipDays / const_158;
            _controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            _controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_587 || !_controller)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_587.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         {
            _loc11_ = param2.monthsRequired * const_158;
            if(param2.isVip)
            {
            ...
            {
               _loc13_ = _loc12_ % const_158;
               _loc14_ = _loc12_ / const_158;
