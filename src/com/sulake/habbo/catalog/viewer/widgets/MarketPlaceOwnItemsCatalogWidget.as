package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1449,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc10_ = _loc6_[_loc7_];
            _loc11_ = param1.getValue(_loc10_) as MarketPlaceOfferData;
            if(_loc11_.status == MarketPlaceOfferState.const_506)
            {
               _loc5_++;
            }
            ...
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_986)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_982)
                  {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_986,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_506,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_982,_loc2_);
            }
         }
