package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_845:MarketPlaceOfferData;
      
      private const const_1450:int = 1;
      
      private const const_1715:int = 40;
      
      private var var_491:IWindowContainer;
      
      private const const_1449:int = 2;
      ...
      private const const_1716:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_491)
         {
            ...
            var_491 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_491)
         {
            return;
         ...
         updateStatusDisplay(const_1449,_loc2_.length);
         if(!var_401)
         {
            var_401 = new Timer(25);
            var_401.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_844 = 0;
         populateList();
         var_401.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_587)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_491 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_491.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1450);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      override public function dispose() : void
      {
         ...
         if(var_401)
         {
            var_401.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_401 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_844 >= var_587.length)
            {
               return true;
            }
            addListItem(var_587.getWithIndex(var_844));
            ++var_844;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_845.offerId);
            }
            return;
         }
