package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1143:IButtonWindow;
      
      private var var_1142:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1143 != null)
         {
            var_1143.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1142 != null)
         {
            var_1142.removeEventListener(WindowKeyboardEvent.const_149,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1143 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1143 != null)
         {
            var_1143.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1142 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1142 != null)
         {
            var_1142.addEventListener(WindowKeyboardEvent.const_149,windowKeyEventProcessor);
         }
      }
