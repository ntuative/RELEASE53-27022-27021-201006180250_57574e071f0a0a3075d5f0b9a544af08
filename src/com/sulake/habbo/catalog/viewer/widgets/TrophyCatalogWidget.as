package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_470.getWithIndex(var_218);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_573);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         events.addEventListener(WidgetEvent.CWE_TEXT_INPUT,method_9);
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_470.getValue(_loc6_) == null)
            {
               var_470.add(_loc6_,new Map());
            }
            _loc8_ = var_470.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_470.getWithIndex(var_218);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_573);
            if(_loc3_ == null)
            {
      ...
      public function method_9(param1:TextInputEvent) : void
      {
