package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1747:int = 3;
      
      public const const_1695:int = 2;
      ...
      private var var_2259:MarketplaceItemStats;
      
      private var var_2262:int = -1;
      ...
      private var var_199:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1487,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2069 || param1.furniTypeId != var_2065)
         {
            return;
         }
         var_2259 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_210.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1695,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_210.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_210.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_506)
            {
               var_210.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2258 = _loc3_.creditsWaiting;
         var_210 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_210.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_199)
         {
            var_199 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_199.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2260,var_2261,var_2231,var_2262);
      }
