package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_748:MarketPlaceLogic;
      
      private var _window:IFrameWindow;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_77:MarketPlaceOfferData;
      ...
      {
         if(var_77 && var_77.imageCallback == param1)
         {
            var_77.image = param2;
            setImage();
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "buy_button":
               _catalog.buyMarketPlaceOffer(var_77.offerId);
               hide();
               break;
      ...
      public function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         ...
         if(_loc3_)
         {
            if(param1 == var_748.const_1487)
            {
               _loc3_.text = "${catalog.marketplace.confirm_header}";
            }
            if(param1 == var_748.const_1695)
            {
         ...
         if(_loc3_)
         {
            ...
            _loc4_ = _loc4_.replace("%price%",var_77.price);
            _loc3_.text = _loc4_;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%days%",var_748.averagePricePeriod.toString());
               _loc6_ = false ? " - " : var_77.averagePrice.toString();
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%count%",var_77.offerCount);
               _loc3_.text = _loc4_;
            }
            else
            {
      ...
      private function setImage() : void
      {
         ...
         if(true)
         {
            if(false)
            {
               _loc1_ = _roomEngine.getFurnitureIcon(var_77.furniId,this);
            }
            else if(false)
            {
               _loc1_ = _roomEngine.getWallItemIcon(var_77.furniId,this);
            }
            if(_loc1_ && _loc1_.data)
            {
               var_77.image = _loc1_.data as BitmapData;
               var_77.imageCallback = _loc1_.id;
            }
         }
         if(false)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.bitmap.draw(var_77.image,new Matrix(1,0,0,1,(_loc2_.width - var_77.image.width) / 2,(_loc2_.height - var_77.image.height) / 2));
            }
         }
      }
