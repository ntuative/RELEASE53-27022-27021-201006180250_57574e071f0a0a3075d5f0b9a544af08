package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1080 + var_1080 / -var_2492 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_891 - var_891 / var_438 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc3_.draw(_loc6_);
         var_1080 = param1 - _loc6_.textWidth - 2;
         var_891 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_891);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_891 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(var_1080 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1080,(param2 - var_891) / 2));
         return _loc3_;
      }
