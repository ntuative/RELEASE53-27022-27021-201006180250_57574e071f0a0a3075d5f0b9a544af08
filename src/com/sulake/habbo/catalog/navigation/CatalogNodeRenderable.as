package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1692:XML;
      
      private static var var_1693:XML;
       
      
      private var var_2476:IWindowContainer;
      ...
      private var var_1691:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1691 == 4294967295)
            {
               var_1691 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1176;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1692) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1693) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1232;
            }
         }
      }
