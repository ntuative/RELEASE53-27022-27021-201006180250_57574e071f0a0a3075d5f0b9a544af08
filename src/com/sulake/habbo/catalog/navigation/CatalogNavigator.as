package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2487:String = "magic.pixels";
      
      private var var_2488:String = "catalog.page.club";
      
      private var var_2503:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "HabboRoomWidgetLib_memenu_settings_slider_button";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2488,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_260.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_260)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_260.indexOf(_loc6_);
            var_260.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
