package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_815:int = 0;
      
      public static const const_185:int = 5;
      
      private static const const_371:int = 1;
      
      private static const const_816:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1652)
         {
            case RecyclerStatusMessageEvent.const_1401:
               var_287 = const_371;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_885:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1336:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1652 != RecyclerStatusMessageEvent.const_885;
      }
      
      private function get statusActive() : Boolean
      {
         return var_287 != const_815;
      }
      ...
      {
         return active && var_287 == const_371;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_185)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_924:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1427:
