package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeLevelContainer
   {
      ...
      public function PrizeLevelContainer(param1:PrizeLevelMessageData, param2:IHabboCatalog)
      {
         ...
         var _loc6_:* = null;
         super();
         var_1317 = param1.prizeLevelId;
         param2.localization.registerParameter("recycler.prizes.odds." + var_1317,"odds","1:" + param1.probabilityDenominator);
         var_743 = new Array();
         var _loc3_:int = 0;
         while(_loc3_ < param1.prizes.length)
         {
            ...
            _loc6_ = new PrizeContainer(_loc4_.productItemType,_loc4_.productItemTypeId,_loc5_,var_1317);
            var_743.push(_loc6_);
            _loc3_++;
         }
      }
