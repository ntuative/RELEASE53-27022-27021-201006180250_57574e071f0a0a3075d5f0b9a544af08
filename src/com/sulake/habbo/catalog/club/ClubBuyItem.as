package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         _window = var_467.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!var_467 || true || !var_467.viewer.catalog || !var_467.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = var_467.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (var_467.viewer.catalog as HabboCatalog).getClubBuyController();
         (var_467.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_77,var_467);
      }
   }
}
