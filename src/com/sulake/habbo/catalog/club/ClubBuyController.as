package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_199:ClubBuyConfirmationDialog;
      ...
      {
         closeConfirmation();
         var_199 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         var_587.sort(orderByPrecedence);
         for each(_loc6_ in var_587)
         {
