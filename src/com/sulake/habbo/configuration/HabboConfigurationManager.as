package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1514:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_549 = getKey("url_prefix");
         if(var_549 != null && false)
         {
            setKey("client.fatal.error.url",var_549 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1322);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1138[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         if(getKey("local.environment") == "HabboRoomWidgetLib_memenu_settings_slider_button")
         {
            setKey("url.prefix",getKey("url.prefix.local"));
         }
         var_549 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_549.replace("http://","");
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_870 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_174));
         if(var_2222)
         {
      ...
      {
         var _loc4_:String = var_1138[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_549);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1514);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1514,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
