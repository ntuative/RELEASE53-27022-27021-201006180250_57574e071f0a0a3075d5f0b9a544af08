package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_880:BitmapData = null;
      ...
      private var var_881:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_394,0,0,_loc4_,var_1566,var_881,var_880));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1952 = _config.getKey("interstitial.enabled","false") == "HabboRoomWidgetLib_memenu_settings_slider_button";
         var_1951 = int(_config.getKey("interstitial.interval","30000"));
         var_1950 = int(_config.getKey("interstitial.show.time","5000"));
         var_1565 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1297 = _loc2_.imageUrl;
         var_1566 = _loc2_.clickUrl;
         if(var_1297 != "" && var_1566 != "")
         {
            _loc3_ = var_1297;
            ...
            _loc4_ = new URLRequest(var_1297);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1298 = _loc2_.imageUrl;
         var_1949 = _loc2_.clickUrl;
         var_733 = getTimer();
         if(var_1298 != "")
         {
            _loc3_ = var_1298;
            ...
            var_234.start();
            _loc4_ = new URLRequest(var_1298);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_492,0,0,param1.bitmapData,var_1949));
            var_733 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_880 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1565 > 0 && var_1567 >= var_1565)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_733;
         if(_loc1_ > var_1951)
         {
            ++var_1567;
      ...
      {
         var_336 = param2 as IHabboCommunicationManager;
         if(var_336 == null)
         {
            return;
         }
         _connection = var_336.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_510));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_881 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
