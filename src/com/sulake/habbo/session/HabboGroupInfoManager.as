package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_291.getValue(_loc2_.groupId);
         var_1083[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_291.getValue(_loc4_) != null)
            {
               var_291.remove(_loc4_);
            }
            var_291.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_291.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_1083[param1];
         if(_loc2_ == null)
         {
