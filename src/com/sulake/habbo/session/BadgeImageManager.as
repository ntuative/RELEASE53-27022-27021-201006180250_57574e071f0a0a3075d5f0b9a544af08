package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1205:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_965:String = "group_badge";
       
      
      private const const_1468:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1468,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1468 + param1;
         ...
         switch(param2)
         {
            case const_1205:
               if(var_143 != null)
               {
                  _loc5_ = var_143.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_965:
               if(var_143 != null)
               {
                  if(var_143 != null)
                  {
                     _loc5_ = var_143.getKey("group.badge.url");
