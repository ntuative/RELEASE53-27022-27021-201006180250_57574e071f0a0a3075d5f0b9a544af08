package com.sulake.habbo.session.product
{
   ...
   public class ProductDataParser extends EventDispatcher
   {
      ...
      public function ProductDataParser(param1:String, param2:Dictionary)
      {
         super();
         var_963 = param2;
         var_727 = new AssetLibrary("ProductDataParserAssetLib");
         var _loc3_:AssetLoaderStruct = var_727.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
