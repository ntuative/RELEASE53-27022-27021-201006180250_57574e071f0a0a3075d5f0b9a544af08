package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1023:UserDataManager;
      ...
      {
         if(var_35 == RoomSessionEvent.const_315 && _connection != null)
         {
            var_35 = RoomSessionEvent.const_101;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1023 as IUserDataManager;
      }
