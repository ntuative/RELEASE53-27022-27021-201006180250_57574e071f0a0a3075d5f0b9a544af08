   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_135,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onFlatAccessible(param1:FlatAccessibleMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_56,_loc6_,_loc5_));
            }
         }
      }
