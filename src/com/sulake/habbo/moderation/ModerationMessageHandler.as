package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_1025,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_844,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_683,_loc2_.data.roomId,_loc3_,_loc4_);
      }
