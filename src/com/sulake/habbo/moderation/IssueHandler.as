package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_423:UserInfoCtrl;
      
      private var var_59:ModerationManager;
      
      private var var_1062:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.releaseBundle(var_115.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_423 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1062 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_423.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_115.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1062.load(_loc4_,var_115.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_115.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_1025,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_59 != null && false && var_115 != null)
         {
            var_59.issueManager.removeHandler(var_115.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_423 = new UserInfoCtrl(_window,var_59,_loc3_.message);
            var_423.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_115.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_115.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1368;
      }
   }
}
