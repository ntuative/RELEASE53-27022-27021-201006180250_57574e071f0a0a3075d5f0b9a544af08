package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_683,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_425);
         if(param1.flatId != var_425)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_425);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_784.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1415,_loc2_,var_462.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1127.isSelected,var_1126.isSelected,var_784.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_943 = IDropMenuWindow(var_53.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_943);
         var_943.procedure = onSelectTemplate;
         var_784 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1127 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1126 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_425));
         Logger.log("BEGINNING TO SHOW: " + var_425);
      }
   }
}
