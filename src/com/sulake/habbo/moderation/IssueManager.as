package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_881:String = "issue_bundle_open";
      
      public static const const_751:String = "issue_bundle_my";
      
      public static const const_917:String = "issue_bundle_picked";
      ...
      private var var_620:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_133 = new Map();
         var_889 = new Map();
         var_620 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_741 = [];
         var_888 = [];
         var_1079 = new Map();
      }
      ...
      {
         var _loc2_:IssueBundle = var_133.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_741 = var_741.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(_loc2_ != 0)
         {
            _loc3_ = var_133.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
         ...
         if(param1.state == IssueMessageData.const_1389)
         {
            var_154.remove(param1.issueId);
            return;
         }
         ...
         if(_loc3_ == null)
         {
            ...
            var_133.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_741.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_145)
         {
            _loc5_ = getBundles(const_751);
            _loc6_ = false;
            ...
            _loc8_ = var_888.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_888 = var_888.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_133.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_133.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_620 == null || !var_620.isOpen())
         {
            var_59.soundManager.playSound(HabboSoundTypesEnum.const_926);
         }
      }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_133.getValues();
