package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1318 ? 0 : 1,_roomId),_main,WindowTracker.const_683,_roomId),var_53,false,false,true);
      }
