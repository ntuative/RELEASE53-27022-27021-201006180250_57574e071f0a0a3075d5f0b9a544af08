package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1518:IMessageComposer;
      ...
      {
         var_911 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_910 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1518);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_911.clone());
      ...
      {
         if(param1.type != WindowEvent.const_48 || param2 != var_53)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_910.clone());
         _loc4_.color = var_1344[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
