package com.sulake.habbo.moderation
{
   ...
   public class PickedIssuesView implements IIssueBrowserView
   {
      ...
      private var var_1894:IssueListView;
      ...
      public function PickedIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_620 = param2;
         _window = var_620.createWindow("picked_issues_xml") as IWindowContainer;
         param3.addChild(_window);
         var _loc4_:IItemListWindow = _window.findChildByName("issue_list") as IItemListWindow;
         var_1894 = new IssueListView(param1,param2,_loc4_,"picked_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_917);
         var_1894.update(_loc1_);
      }
   }
}
