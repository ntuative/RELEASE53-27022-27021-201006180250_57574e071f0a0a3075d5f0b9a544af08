package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1666:IIssueBrowserView;
      
      private const const_1735:String = "open_issues";
      ...
      private var var_1665:IIssueBrowserView;
      ...
      private var var_1667:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_251 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_251.numTabItems)
            {
               _loc5_ = var_251.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_251.selector.getSelectableByName("open_issues");
         var_251.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_380.view.width = var_251.container.width;
         var_380.view.height = var_251.container.height;
         var_380.visible = true;
         var_380.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1736:
               if(var_1665 == null)
               {
                  var_1665 = new MyIssuesView(issueManager,this,var_251.container);
               }
               return var_1665;
            case const_1735:
               if(var_1666 == null)
               {
                  var_1666 = new OpenIssuesView(issueManager,this,var_251.container);
               }
               return var_1666;
            case const_1734:
               if(var_1667 == null)
               {
                  var_1667 = new PickedIssuesView(issueManager,this,var_251.container);
               }
               return var_1667;
            default:
               return null;
