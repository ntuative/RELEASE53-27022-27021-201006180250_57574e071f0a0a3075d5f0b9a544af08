package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1713:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1713.clone());
      ...
      {
         var_1713 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
