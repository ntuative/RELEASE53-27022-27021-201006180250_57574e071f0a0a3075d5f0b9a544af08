package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1423:int = 6;
      
      public static const const_683:int = 4;
      
      public static const TYPE_ROOMINFO:int = 9;
      
      public static const const_1202:int = 7;
      
      public static const const_1025:int = 3;
      
      public static const const_1368:int = 8;
      
      public static const const_844:int = 5;
      ...
      private var var_1603:Dictionary;
      
      public function WindowTracker()
      {
         var_1603 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1603[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1603[param1] = _loc2_;
         }
         return _loc2_;
      }
