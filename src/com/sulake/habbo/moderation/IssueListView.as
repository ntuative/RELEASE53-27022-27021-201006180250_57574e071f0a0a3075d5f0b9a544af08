package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1541:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_49 = param3;
         var_1394 = param4;
         var_1541 = var_620.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1541 == null)
            {
               return;
            }
            _loc2_ = var_1541.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_620.assets.getAssetByName(_loc8_) as BitmapDataAsset;
