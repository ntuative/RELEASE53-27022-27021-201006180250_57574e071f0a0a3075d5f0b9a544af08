package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1020:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_584 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_584.width;
         var_94 = var_584.height;
         var_1019 = param5;
         var_829 = param6;
         var_222 = Math.floor(var_1019 / _thumbWidth);
         var_18 = new BitmapData(var_1019,var_829);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_18.height < var_829)
         {
            _loc12_ = new BitmapData(var_18.width,var_829);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_584.width,var_584.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_584.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_584,var_584.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1020 != null)
         {
            _loc1_ = var_1020.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_18 = new BitmapData(Math.max(var_222 * _thumbWidth,var_1019),Math.max(var_479 * var_94,var_829),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_222 && var_18.height < _loc3_.y * var_94)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_222 - 1),var_94);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_222 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_222 - 1),0 - var_94);
