package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2415:BitmapData;
      
      protected var var_1015:Boolean;
      ...
      private const const_1465:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_747)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1682));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1465;
               _loc1_.blend = const_1465;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1479 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2415;
               _loc5_.visible = true;
            }
            else
            {
