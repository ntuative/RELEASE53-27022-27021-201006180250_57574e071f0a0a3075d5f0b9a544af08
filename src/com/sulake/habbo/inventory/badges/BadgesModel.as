package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1737:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_364 = param6;
         var_364.events.addEventListener(BadgeImageReadyEvent.const_128,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_977.length)
         {
            if(var_977[_loc2_] == param1)
            {
               var_977.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_291[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_291.length)
               {
                  if((var_291[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_291[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_364.getBadgeImage(param1);
            var_291.push(_loc8_);
            if(param2)
            {
