package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_331:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_498 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_665.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_331 != null)
         {
            var_331.setSelected(false);
         }
         var_331 = param1;
         if(var_331 != null)
         {
            var_331.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_331.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_665.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_498.removeGridItem(_loc2_.window);
         if(var_331 == _loc2_)
         {
            var_331 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_665.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_498.addGridItem(_loc2_.window);
            var_665.add(param1.id,_loc2_);
            if(var_331 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_54,this);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_35,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_35);
            _loc3_ = _loc12_.name;
