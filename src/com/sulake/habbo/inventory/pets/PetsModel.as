package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1315 && param1.type == RoomEngineObjectEvent.const_221)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1315 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_238,_loc3_.figure);
      ...
      {
         if(var_1070.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
