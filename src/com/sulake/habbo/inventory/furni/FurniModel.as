package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_345:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_493 = new Timer(const_1082,1);
         var_493.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_412.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_412.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_747)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_493 != null)
            {
               var_493.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_493.stop();
               var_493 = null;
            }
            if(var_127 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_717 == null)
         {
            var_717 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_717.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_254:
               ...
               break;
            case InventorySubCategory.const_867:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_322);
         ...
         if(param1 == InventoryCategory.const_79 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_345:
                  _controller.toggleInventoryPage(InventoryCategory.const_157);
            }
         }
      }
      ...
      {
         if(var_853 && param1.type == RoomEngineObjectEvent.const_221)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_327 || _loc3_.category == FurniCategory.const_349 || _loc3_.category == FurniCategory.const_338)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_412.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_412 = new Map();
         var_412.add(const_44,new Array());
         var_412.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
