package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_498 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_498.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_498.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_498.addGridItemAt(param1,param2);
      ...
      {
         return var_498.removeGridItemAt(param1);
      }
      
      public function addItemToBottom(param1:IWindowContainer) : void
      {
         var_498.addGridItem(param1);
         param1.procedure = itemEventProc;
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_52)
         {
            ...
            _model.toggleItemSelection(_category,var_498.getGridItemIndex(param1.window));
            var_353 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_33 && var_353 != null && var_353 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_275)
         {
