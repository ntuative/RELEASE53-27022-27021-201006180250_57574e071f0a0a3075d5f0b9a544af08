package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_789:uint = 4284532064;
      
      private static const const_788:uint = 2577770;
      
      public static const const_939:int = 0;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_358 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_193)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_868)
            {
            ...
            var_358.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_450);
            var_358.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_178)
            {
               var_178.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_178.stop();
               var_178 = null;
            }
            if(var_358 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1597 == null)
         {
            var_1597 = createMinimizedWindow();
         }
         if(!var_2070)
         {
            return var_65;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_178 == null)
         {
            var_178 = new Timer(1000,3);
            var_178.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_178.reset();
         var_178.repeatCount = 3;
         var_178.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_789) : uint(const_788);
            }
