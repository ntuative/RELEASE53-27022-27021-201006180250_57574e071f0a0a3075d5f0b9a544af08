package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_874:IRoomSession;
      ...
      private const const_1718:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_421,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_534));
      }
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_157));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_896));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1718);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_325));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_873.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_873.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_254));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_364 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_873.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_47.getValue(InventoryCategory.const_322) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1071 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_256));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_107,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_421,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_322,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_364);
         var_47.add(InventoryCategory.const_256,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_534,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_364);
         var_47.add(InventoryCategory.const_325,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_254,_loc8_);
         ...
         var_47.add(InventoryCategory.const_157,_loc10_);
