package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_1863 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1863);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1536.toString());
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboRoomWidgetLib_memenu_settings_slider_button" == _config.getKey("client.credits.embed.enabled"))
         {
