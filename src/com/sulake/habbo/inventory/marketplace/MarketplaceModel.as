package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_241 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_241.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_241 is FloorItem ? 1 : 2;
         var_2069 = _loc2_;
         var_2065 = var_241.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_241.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1595,var_1596);
         }
      }
      ...
      {
         if(param1 != var_2069 || param2 != var_2065)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_2063);
      }
      ...
      {
         if(_controller != null && false && var_241 != null)
         {
            _controller.furniModel.removeLockFrom(var_241.id);
            var_241 = null;
         }
      }
