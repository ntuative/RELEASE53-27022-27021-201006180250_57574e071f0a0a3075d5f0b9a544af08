package com.sulake.core.communication.messages
{
   ...
   public class MessageClassManager implements IMessageClassManager
   {
      ...
      public function getMessageComposerID(param1:IMessageComposer) : int
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = -1;
         for(_loc3_ in var_887)
         {
            _loc4_ = var_887[_loc3_] as Class;
            if(param1 is _loc4_)
            {
      ...
      {
         var _loc2_:Array = var_738[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function toString() : String
      {
         ...
         for(_loc2_ in var_887)
         {
            _loc1_ += _loc2_ + " -> " + var_887[_loc2_] + "\n";
         }
         _loc1_ += "Registered Message Event Classes: \n";
         for(_loc2_ in var_738)
         {
            _loc1_ += _loc2_ + " -> " + var_738[_loc2_] + "\n";
         }
         return _loc1_;
      }
