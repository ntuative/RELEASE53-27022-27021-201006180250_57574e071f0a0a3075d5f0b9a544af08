package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_660:IProtocol;
      
      private var var_960:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_336 = param2;
         var_286 = new ByteArray();
         var_960 = new MessageClassManager();
         var_74 = new Socket();
         var_373 = new Timer(const_1254,1);
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_795));
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         var_373.stop();
         var_1400 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_795));
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_960.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = var_660.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_374)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_286.writeByte(var_74.readUnsignedByte());
         }
         logConnection(">>[SOCKET]: " + var_286.toString());
      }
      ...
      {
         var_336.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_795));
         dispatchEvent(param1);
      }
      ...
      {
         var_960.registerMessages(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_795));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = var_660.getMessages(var_286,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(var_374)
               {
                  var_374.messageReceived(String(id),data.toString());
               }
               logConnection(">>[SocketConnection] timestamp:" + getTimer() + " Received message id: " + id + " data: " + data.toString());
               eventClasses = var_960.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = var_336.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  else
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = var_336.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(var_286,offset);
               var_286 = temp;
               logConnection("[SOCKET REST] offset: " + offset + " rest: " + var_286.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_795));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         ...
         var_1400 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_795));
         dispatchEvent(param1);
      }
