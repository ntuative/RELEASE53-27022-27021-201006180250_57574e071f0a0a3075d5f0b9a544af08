package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1365:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_449)
         {
            _loc10_;
            if(var_449[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_768[_loc3_];
      ...
      {
         var _loc3_:Array = var_768[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_768[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         if(param1 == null || var_449 == null)
         {
            return null;
         }
         return var_449[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1366)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_767[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_449)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1044:
               _loc3_ = new SocketConnection(param1,this,var_1365);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_449[param1] = _loc3_;
         return _loc3_;
      }
