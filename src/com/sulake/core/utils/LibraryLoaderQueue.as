package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1439:int = 4;
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         _loc2_ = var_603.indexOf(param1);
         if(_loc2_ > -1)
         {
            var_603.splice(_loc2_,1);
         }
         _loc2_ = var_258.indexOf(param1);
         if(_loc2_ > -1)
         {
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(var_258.length < const_1439 && false)
            {
               _loc1_ = var_603.shift();
               var_258.push(_loc1_);
               _loc1_.resume();
            }
         }
