package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1095:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_633:uint = 0;
      
      public static const const_729:String = "AssetLibraryReady";
      
      public static const const_1396:String = "AssetLibraryUnloaded";
      ...
      private var var_524:Boolean = true;
      
      private var var_361:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_633;
         var_445 = new Dictionary(false);
         var_444 = new Dictionary(false);
         var_755 = new Dictionary(false);
         var_135 = new Dictionary(false);
         var_1095.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_445)
         {
            _loc4_ = AssetTypeDeclaration(var_445[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = var_444[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_444[_loc1_];
         }
         for(_loc1_ in var_135)
         {
            delete var_135[_loc1_];
         }
         for(_loc1_ in var_755)
         {
            delete var_755[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
         ...
         var_320 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1396));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_523 = _loc2_.manifest.copy();
         var_361 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_524)
         {
            AssetLibrary.fetchLibraryContents(this,var_523,var_361);
         }
         var_320 = true;
         dispatchEvent(new Event(AssetLibrary.const_458));
         dispatchEvent(new Event(AssetLibrary.const_729));
         if(var_524)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_444[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_893,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_910,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1035,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_993,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_444[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_445.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_445[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1095.splice(var_1095.indexOf(this),1);
            --var_633;
            var_444 = null;
            var_755 = null;
            var_135 = null;
      ...
      {
         return param1 < var_362.length ? getAssetByName(var_362[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_135)
         {
            if(var_135[_loc2_] == param1)
            {
               return var_362.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_445)
         {
            _loc3_ = AssetTypeDeclaration(var_445[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_755[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_523.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_361[param1]);
      ...
      {
         var _loc2_:IAsset = var_135[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_444[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++var_202;
                     var_362.push(struct.assetName);
                  }
                  var_135[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_47,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_135)
            {
               if(var_135[_loc2_] == param1)
               {
                  var_362.splice(var_362.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_445[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_361 != null ? false : false;
      }
   }
}
