package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_468:uint = 0;
      
      protected var var_2480:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_2028:Boolean = false;
      
      protected var _events:EventDispatcher;
      
      protected var var_190:InterfaceStructList;
      
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1190 = param2;
         var_190 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_190.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1010 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1010);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1190 & const_890)
         {
            if(_loc3_ == 0)
            {
               if(var_190.method_8() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_190.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_468 + "]";
      }
