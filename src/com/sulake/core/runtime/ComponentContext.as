package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected var var_258:Array;
      
      protected var var_391:Array;
      
      protected var var_683:Boolean = false;
      
      protected var var_301:Array;
      
      protected var var_221:DisplayObjectContainer;
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1314);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         {
            if(var_258[_loc3_].url == param1.url)
            {
               return var_258[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
         var _loc4_:LibraryLoader = new LibraryLoader(param2,var_683);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc8_:uint = var_190.mapStructsByImplementor(this,_loc7_);
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_301.length)
         {
            _loc10_ = var_301[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_391 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_391.pop()).dispose();
               }
               var_391 = null;
            }
            if(var_258 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_391[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1215);
      }
      
      public final function detachComponent(param1:Component) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = var_190.getIndexByImplementor(param1);
         while(_loc3_ > -1)
         {
            _loc2_ = var_190.remove(_loc3_);
            _loc3_ = var_190.getIndexByImplementor(param1);
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_301.length)
         {
            if(var_301[_loc4_] == param1)
            {
               var_301.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_537);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_537);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_537);
                  }
               }
      ...
      {
         var _loc3_:InterfaceStruct = var_190.getStructByInterface(param1);
         if(_loc3_ != null)
         {
      ...
      public final function attachComponent(param1:Component, param2:Array) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            var_190.insert(new InterfaceStruct(_loc5_,param1));
            _loc3_++;
         }
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
