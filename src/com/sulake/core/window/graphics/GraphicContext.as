package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1701:uint = 128;
      
      public static const const_1610:uint = 64;
      ...
      protected var var_682:Boolean;
      
      protected var var_1708:Boolean;
      
      protected var var_168:DisplayObjectContainer;
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_168 = new Sprite();
            var_168.name = this.name + " - Child Container";
            var_168.mouseEnabled = false;
            addChild(var_168);
         }
         return var_168;
      }
         ...
         if(var_682)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1708,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1708,16777215);
                  }
                  var_395 += bitmap.width * bitmap.height * 4;
               }
