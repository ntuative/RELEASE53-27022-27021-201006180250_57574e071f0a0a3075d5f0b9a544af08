package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_804:uint = 8;
       
      
      private var var_2173:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1631 = new Dictionary();
         var_2174 = new Dictionary();
         TypeCodeTable.fillTables(var_1631,var_2174);
         var_1380 = new Dictionary();
         var_2173 = new Dictionary();
         StateCodeTable.fillTables(var_1380,var_2173);
         var_539 = new Dictionary();
         var_539["skin"] = BitmapSkinRenderer;
         var_539["bitmap"] = BitmapDataRenderer;
         var_539["fill"] = FillSkinRenderer;
         var_539["text"] = TextSkinRenderer;
         var_539["shape"] = ShapeSkinRenderer;
         var_539["unknown"] = SkinRenderer;
         var_539["LandscapePlane"] = NullSkinRenderer;
         if(var_396 == null)
         {
            var_396 = new Array();
            var_396.push(WindowState.const_66);
            var_396.push(WindowState.const_74);
            var_396.push(WindowState.const_99);
            var_396.push(WindowState.WINDOW_STATE_SELECTED);
            var_396.push(WindowState.const_85);
            var_396.push(WindowState.const_77);
            var_396.push(WindowState.const_95);
            var_396.push(WindowState.const_86);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1380)
         {
            _loc3_.push(var_1380[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "HabboRoomWidgetLib_memenu_settings_slider_button" : false;
                  ...
                  addSkinRenderer(var_1631[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_776[param1];
      ...
      {
         var _loc3_:Array = var_777[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_777[param1] = new Array(SkinContainer.const_804);
         }
         var_777[param1][param2] = param3;
         if(true)
         {
            var_776[param1] = new Array(SkinContainer.const_804);
         }
         var_776[param1][param2] = param4;
      }
