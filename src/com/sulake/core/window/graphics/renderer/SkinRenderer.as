package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_342:Dictionary;
      
      protected var var_343:Dictionary;
      
      protected var var_477:Dictionary;
      ...
      {
         var _loc3_:ISkinLayout = var_477[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_342[param2];
         if(_loc3_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_477[_loc1_]).dispose();
            delete var_477[_loc1_];
         }
         var_477 = null;
         _layoutsByState = null;
         for(_loc1_ in var_342)
         {
            ISkinTemplate(var_342[_loc1_]).dispose();
            delete var_342[_loc1_];
         }
         var_342 = null;
         var_343 = null;
      }
