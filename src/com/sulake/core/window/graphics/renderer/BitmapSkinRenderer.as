package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_685:Dictionary;
      
      private var var_789:Matrix;
      
      protected var var_684:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_684 = new Dictionary(false);
         var_685 = new Dictionary(false);
         var_789 = new Matrix();
      }
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_684[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_274)
                  {
                     _loc13_.x += _loc16_;
                  }
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_423)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_294)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_274)
                  {
                     _loc13_.y += _loc17_;
                  }
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_423)
                  {
                     _loc15_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_294)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_294 || _loc11_.scaleH == SkinLayoutEntity.const_294)
                  {
                  ...
                  {
                     var_789.a = _loc13_.width / _loc19_.width;
                     var_789.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_789);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_789,null);
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc2_ = var_684[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_684[_loc1_];
         }
         var_684 = null;
         for(_loc1_ in var_685)
         {
            _loc2_ = var_685[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_685[_loc1_];
         }
         var_685 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_685[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
