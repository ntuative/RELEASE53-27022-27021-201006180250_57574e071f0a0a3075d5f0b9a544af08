package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1639:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_654 = new Array();
         var_1638 = new Point();
         var_1639 = new Rectangle();
         var_327 = new Rectangle();
         var_328 = new Dictionary(true);
         var_740 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_328[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_654.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_327.x = _loc3_.dirty.x;
               var_327.y = _loc3_.dirty.y;
               var_327.width = _loc3_.dirty.width;
               var_327.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_327);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_665,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_328[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_328[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_654 = null;
            for(_loc1_ in var_328)
            {
               delete var_328[_loc1_];
            }
            var_328 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1638,var_1639))
            {
               if(param2.render(param1,var_1638,var_1639))
               {
                  ...
                  while(_loc7_ < _loc4_)
                  {
                     ...
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_36))
                        {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_740);
            var_328[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_665,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_80);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_327.x = param2.x - param1.x;
            var_327.y = param2.y - param1.y;
            var_327.width = param2.width;
            var_327.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_36))
            {
               while(param1.testParamFlag(WindowParam.const_36))
               {
                  ...
                  var_327.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_327,WindowRedrawFlag.const_269);
            if(var_654.indexOf(param1) == -1)
            {
               var_654.push(param1);
            }
         }
