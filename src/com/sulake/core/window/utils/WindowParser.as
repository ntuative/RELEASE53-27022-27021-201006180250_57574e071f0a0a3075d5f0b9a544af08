package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1673:String = "_INCLUDE";
      
      public static const const_911:String = "_EXCLUDE";
      
      public static const const_1688:String = "_TEMP";
      
      private static const const_1079:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1080:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1195:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_1011:Dictionary;
      
      protected var var_1475:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1474:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1195 = new Dictionary();
         TypeCodeTable.fillTables(var_1196,var_1195);
         var_1011 = new Dictionary();
         var_1474 = new Dictionary();
         ParamCodeTable.fillTables(var_1011,var_1474);
         var_1475 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1080,"");
         return param1.replace(const_1079,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1196)
            {
               delete var_1196[_loc1_];
            }
            for(_loc1_ in var_1195)
            {
               delete var_1195[_loc1_];
            }
            for(_loc1_ in var_1011)
            {
               delete var_1011[_loc1_];
            }
            for(_loc1_ in var_1474)
            {
               delete var_1474[_loc1_];
            }
            var_1475.dispose();
            var_1475 = null;
            var_16 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "HabboRoomWidgetLib_memenu_settings_slider_button";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "HabboRoomWidgetLib_memenu_settings_slider_button";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "HabboRoomWidgetLib_memenu_settings_slider_button";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_911) == -1)
                  {
