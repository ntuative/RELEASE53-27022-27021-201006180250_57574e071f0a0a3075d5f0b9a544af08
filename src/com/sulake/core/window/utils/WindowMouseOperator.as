package com.sulake.core.window.utils
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      public function operate(param1:int, param2:int) : void
      {
         _mouse.x = param1;
         _mouse.y = param2;
         getMousePositionRelativeTo(_window,_mouse,var_575);
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(_working)
         {
            if(_window == param1)
            {
               ...
               if(true)
               {
                  _window.removeEventListener(WindowEvent.const_491,clientWindowDestroyed);
               }
               _window = null;
               _working = false;
            }
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _window.addEventListener(WindowEvent.const_491,clientWindowDestroyed);
            _working = true;
         }
         return _loc3_;
      }
