package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_422:int = -2.147483648E9;
      ...
      {
         return var_419 == int.MIN_VALUE && var_421 == int.MAX_VALUE && var_422 == int.MIN_VALUE && var_420 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_421 = param1;
         if(var_421 < int.MAX_VALUE && true && _target.width > var_421)
         {
      ...
      public function setEmpty() : void
      {
         ...
         var_420 = int.MAX_VALUE;
      }
      
      public function set maxHeight(param1:int) : void
      {
         var_420 = param1;
         if(var_420 < int.MAX_VALUE && true && _target.height > var_420)
         {
