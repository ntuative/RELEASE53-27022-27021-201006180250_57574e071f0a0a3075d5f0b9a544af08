package com.sulake.core.window.components
{
   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_426)
         {
            _offsetX = x != 0 ? Number(x / Number(0 - width)) : Number(0);
            var_835 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_9 != _scrollBar)
            {
               _scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_295,this,null));
            }
         }
