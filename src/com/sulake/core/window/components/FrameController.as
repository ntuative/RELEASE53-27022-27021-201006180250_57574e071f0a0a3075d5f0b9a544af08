package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_784:String = "margin_top";
      
      private static const const_1114:String = "_HEADER";
      
      private static const const_787:String = "margin_right";
      
      private static const const_1116:String = "_SCALER";
      
      private static const const_1078:String = "_TITLE";
      
      private static const const_1115:String = "_CONTENT";
      
      private static const const_786:String = "margin_left";
      
      private static const const_785:String = "margin_bottom";
      ...
      private var var_1330:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_786,_loc3_.left,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_784,_loc3_.top,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_787,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_785,0 - _loc3_.bottom,PropertyStruct.const_69,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_276);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_225);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_226);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1330 == null)
         {
            var_1330 = findChildByTag(const_1114) as IHeaderWindow;
            if(!var_1330)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1078) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1116) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_281,false);
         }
      ...
      {
         return content != null && var_579 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1115) as IWindowContainer;
            if(!var_20)
            {
