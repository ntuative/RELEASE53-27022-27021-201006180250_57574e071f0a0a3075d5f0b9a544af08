package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         var _loc3_:* = null;
         if(param2.type == WindowNotifyEvent.const_312)
         {
            if(var_9)
            {
      ...
      public function select() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_339;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_674,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
