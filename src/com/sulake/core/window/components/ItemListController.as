package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1054:String = "resize_on_item_update";
      
      protected static const const_1053:String = "spacing";
      
      protected static const const_1432:Boolean = false;
      ...
      protected static const const_1433:Boolean = true;
      
      protected static const const_1052:String = "auto_arrange_items";
      ...
      protected var var_2482:Number = 0.0;
      ...
      protected var var_1192:Boolean = false;
      
      protected var var_576:Number;
      
      protected var var_191:Boolean = false;
      
      protected var var_91:Number;
      
      protected var var_1472:Boolean = false;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_824:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_91 = 0;
         var_68 = 0;
         _horizontal = param2 == WindowType.const_337;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_169 = var_686 || !testParamFlag(WindowParam.const_36);
         _container = var_16.create("_CONTAINER","",WindowType.const_361,WindowStyle.const_329,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_418,containerEventHandler);
         _container.addEventListener(WindowEvent.const_277,containerEventHandler);
         _container.addEventListener(WindowEvent.const_501,containerEventHandler);
         resizeOnItemUpdate = var_1192;
      }
      ...
      {
         return new Rectangle(var_578 * maxScrollH,var_576 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_418,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_277,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_501,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_578 = param1;
            _container.x = -var_578 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1053,_spacing,PropertyStruct.const_69,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1052,var_824,PropertyStruct.const_60,var_824 != const_1433));
         _loc1_.push(new PropertyStruct(const_1055,var_577,PropertyStruct.const_60,var_577 != const_1432));
         _loc1_.push(new PropertyStruct(const_1054,var_1192,PropertyStruct.const_60,var_1192 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_576 = param1;
            _container.y = -var_576 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_80);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1054:
                  ...
                  break;
               case const_1052:
                  var_824 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_400,param1);
            }
            else
            {
