package com.sulake.core.window.components
{
   ...
   public class SubstituteParentController extends WindowController
   {
      ...
      {
         super("_CONTEXT_SUBSTITUTE_PARENT",0,0,WindowParam.const_36,param1,new Rectangle(0,0,2000,2000),null,null,null,null,0);
         var_169 = false;
      }
      ...
      override public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            param1.removeEventListener(WindowEvent.const_96,childParamUpdated);
            param1.parent = null;
            return param1;
         }
         return null;
      ...
      private function childParamUpdated(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_.removeEventListener(WindowEvent.const_96,childParamUpdated);
         }
         else if(!_loc2_.testParamFlag(WindowParam.const_36))
         {
      ...
      override public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         _loc3_.addEventListener(WindowEvent.const_96,childParamUpdated);
         return param1;
      }
