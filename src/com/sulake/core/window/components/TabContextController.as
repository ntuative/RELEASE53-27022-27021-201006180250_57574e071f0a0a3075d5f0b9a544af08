package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1147:String = "content";
      
      private static const const_1146:String = "selector";
       
      
      private var var_1223:Boolean = false;
      
      protected var var_1016:ITabSelectorWindow;
      
      private var var_870:Boolean = false;
      
      protected var var_1712:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1712 == null)
         {
            var_1712 = findChildByTag(TabContextController.const_1147) as IWindowContainer;
         }
         return var_1712;
      }
      ...
      {
         return var_1016.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1016 == null)
         {
            var_1016 = findChildByTag(TabContextController.const_1146) as ITabSelectorWindow;
            if(var_1016 != null)
            {
               var_1016.procedure = selectorEventProc;
            }
         }
         return var_1016;
      }
      ...
      {
         return !!var_870 ? selector.iterator : null;
      }
