package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1452:String = "TAB_BUTTON_ICON";
      
      private static const const_1451:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1066:String = "TAB_BUTTON_TITLE";
      ...
      {
         if(param2.type == WindowNotifyEvent.const_291)
         {
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1066));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
