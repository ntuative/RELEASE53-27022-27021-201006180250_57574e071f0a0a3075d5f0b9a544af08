package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_580:String = "none";
      
      protected var var_680:Number;
      
      protected var var_390:Number;
      
      protected var _field:TextField;
      
      protected var var_826:Boolean = false;
      ...
      {
         return new Rectangle(var_680 * maxScrollH,var_390 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_826)
         {
            context.removeLocalizationListener(var_341,this);
         }
         if(var_69 != null)
         {
            var_69.dispose();
      ...
      {
         var_680 = param1;
         _field.scrollH = var_680 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_341 = param1;
         if(var_341.charAt(0) == "$" && var_341.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_341.slice(2,var_341.indexOf("}")),this);
            var_826 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1046,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_473,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_60,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_473,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_60,true));
         ...
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_712,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_712,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_60,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_580,PropertyStruct.STRING,var_580 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_60,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_60,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_60,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_60,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_712,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_580 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_580 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_580 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_580 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
