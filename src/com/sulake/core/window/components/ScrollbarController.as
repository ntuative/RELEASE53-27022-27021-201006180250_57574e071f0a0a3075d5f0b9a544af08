package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_780:String = "slider_track";
      ...
      private var var_615:Boolean = false;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_169 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_479;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_516:
               if(param2.type == WindowNotifyEvent.const_295)
               {
                  if(!var_615)
                  {
                     if(_horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_480)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_780) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_878 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_878 != null)
         {
            _loc1_ = findParentByName(var_878) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_878) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_52)
         {
            ...
            else if(param2.name == ScrollbarController.const_780)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_935)
         {
