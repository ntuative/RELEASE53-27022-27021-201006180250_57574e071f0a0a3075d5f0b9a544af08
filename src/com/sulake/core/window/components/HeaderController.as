package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1077:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1078) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1077) as IItemListWindow;
      }
   }
}
