package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_74))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_367)
         {
            var_367 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_367)
            {
               var_367.addEventListener(WindowEvent.const_286,scrollBarEventProc);
               var_367.addEventListener(WindowEvent.const_211,scrollBarEventProc);
            }
         }
         return var_367;
      }
      ...
      override public function dispose() : void
      {
         if(var_367)
         {
            var_367.removeEventListener(WindowEvent.const_286,scrollBarEventProc);
            var_367.removeEventListener(WindowEvent.const_211,scrollBarEventProc);
            var_367 = null;
         }
         if(var_930)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_211)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_930)
         {
            var_930 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_930;
      }
