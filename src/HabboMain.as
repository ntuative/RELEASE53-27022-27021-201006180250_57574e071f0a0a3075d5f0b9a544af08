package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private var var_1200:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         var_1200 = HabboTracking.getInstance();
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_179,null);
         }
      }
         ...
         if(var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               if(_loc4_.fileName == "hh_human_fx.swf" || _loc4_.fileName == "hh_human_body.swf")
               {
                  if(var_1200 && true)
                  {
                     var_1200.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_179,null);
         }
         if(var_28)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_179,null);
         }
      }
